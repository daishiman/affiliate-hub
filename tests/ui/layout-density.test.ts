 ...
 *   6. 線の上下が揃っている（どちらの群の線か分からなくならない）
 *   7. 一覧が 1 画面に収まらない（＝追従が要る、という前提そのものの見張り）
 *   8. 見本帳の「直す前」が、直す前の値を保っている（消えると見比べが無意味になる）
 *
 * 5〜7 は 2026-08-19、利用者の「各分類ごとに横線を引いて区切りが分かるように」から。
