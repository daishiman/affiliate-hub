  ...
  },
  {
    ...
    /*
      ...
      **床 219 も余裕 15 行も動かさない。**同じ 15 行を置き直す（578 + 15 = 593）。
      ...
      2026-09-04: ブログ運営コンソールの確定質疑
      `qa-database-web-domain-aeo-behavior` が正本へ入り、住所表・読者行動表・
      日次ロールアップ・SEO/AEO 評価表の確定内容と、`ddd.md` 由来 2 原則の
      採否・トレードオフが生成節として載った。実測 617 行。
      **これは足された 20 行であって、痩せた結果ではない。**
      **床 219 も余裕 4 行も動かさない。**同じ 4 行を置き直す（617 + 4 = 621）。
    */
    ceiling: 621,
    headings: 21,
    principles: 2,
