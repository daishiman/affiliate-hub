---
graph_node_id: "SYS-READER-SEARCH-QUALITY-P03"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-reader-search-quality"
domain: "quality"
tags: ["p03","feat-reader-search-quality"]
priority: null
start_date: null
target_date: null
iteration: null
title: "設計の独立レビューと外部SaaS非依存・非公開流出防止・境界不可侵ゲート"
owners: ["daishiman"]
created_at: "2026-09-04T04:37:54Z"
updated_at: "2026-09-04T04:37:54Z"
status: "active"
depends_on: ["SYS-READER-SEARCH-QUALITY-P02"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-reader-search-quality/design-review.md"]
purpose: "設計成果物を独立した視点で検査し、外部SaaS非依存・非公開流出防止・feat-blog-top-page-compositionへの非侵犯境界を確定する。"
goal: "設計成果物を独立した視点で検査し、外部SaaS非依存・非公開流出防止・feat-blog-top-page-compositionへの非侵犯境界を確定する。"
scope_in: ["Produced artifacts: design review report","Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P02","Write scope/touches: docs/spec/feat-reader-search-quality/design-review.md"]
...
phase_ref: "P03"
file_path: "tasks/feat-reader-search-quality/sys-reader-search-quality-p03.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T04:37:54Z","origin_kind":"system-dev-planner","source_digest":"b55948e2e68707fa2a8b09dbfe1319c1b799fb956a2f6eaa4f667865b9534d5a","source_path":".dev-graph/published/feature-package-feat-reader-search-quality/task-specs/phase-03-design-review.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-reader-search-qualityのP03 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reader-search-quality/sys-reader-search-quality-p03.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-yvrg","github_mirror":null,"linked_at":"2026-09-04T07:33:47Z","sync_state":"linked"}
...
# System task overlay: 設計の独立レビューと外部SaaS非依存・非公開流出防止・境界不可侵ゲート
...
- parent_feature: feat-reader-search-quality
- phase_ref: P03
- classification: confidence=1.0; reason=feat-reader-search-qualityのP03 lifecycle責務への確定写像; candidate=tasks/feat-reader-search-quality/sys-reader-search-quality-p03.md
...
設計成果物を独立した視点で検査し、外部SaaS非依存・非公開流出防止・feat-blog-top-page-compositionへの非侵犯境界を確定する。

## 背景

読者が言葉から記事へ到達できるようにし、検索窓はあるのに index が無く実質使えない状態を解消する。現状の searchArticles ユースケースは published_articles の題名・要約に対する LIKE 部分一致に留まり、本文は検索されず関連度・新しさによる順位付けも無い。D1 上の FTS5 trigram 索引を公開記事から自動で保ち、日本語の部分一致でも妥当な順で結果が返り、検索結果面がサムネイル付きで表示され、JavaScript が無効でも検索が完了し、画面の検索と WebMCP 道具 searchArticles が同一ユースケースを通り、検索の入口が構造化データと llms.txt にも表れている状態にする。本phaseはSYS-READER-SEARCH-QUALITY-P02の確定成果物を入力にする。

## 前提条件

- Required spec/architecture/phase/task nodes: feat-reader-search-quality, spec-system-spec-index, arch-system-spec-overview, SYS-READER-SEARCH-QUALITY-P02
...
- Frontend: applicable; 検索結果面のbehavior契約と非侵犯境界(SearchAction/ItemList生成非所有)を検査する
- Backend: applicable; 索引migration・同一トランザクション追随の設計整合を検査する
- API: applicable; URL契約とSearchAction target整合の検査可能性を確認する
- Data: applicable; 索引スコープが公開記事に限定されることを検査する
- Infrastructure: N/A: 配備変更なし
- Security: applicable; 検索語literal化と外部SaaS非依存を検査する
- Quality: applicable; C1-C4ゲートを判定する
- Documentation: applicable; レビュー結果を正本化する
- Operations: N/A: 運用手順の検査はP09/P12が担う
...
- Produced artifacts: design review report
- Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P02
- Write scope/touches: docs/spec/feat-reader-search-quality/design-review.md
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-READER-SEARCH-QUALITY-P03を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-READER-SEARCH-QUALITY-P03として割り当てる
- Worktree lease: 実装開始前にSYS-READER-SEARCH-QUALITY-P03をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence: docs/spec/feat-reader-search-quality/design-review.md
- Acceptance state: P03: C1矛盾なし・C2漏れなし・C3整合性あり・C4依存整合に加え、FTS5索引が外部SaaSに依存しないこと、検索語のliteral化により任意のFTS構文が通らないこと、非公開記事が索引スコープに含まれないこと、feat-blog-top-page-compositionが所有するSearchAction/ItemListのJSON-LD生成そのものへの非侵犯境界の全チェックを証拠付きPASSにする。
...
- Rollout: design review reportをwrite_scope内へ適用し、検証PASS後に依存する次phaseへ渡す
...
- Completion condition: P03: C1矛盾なし・C2漏れなし・C3整合性あり・C4依存整合に加え、FTS5索引が外部SaaSに依存しないこと、検索語のliteral化により任意のFTS構文が通らないこと、非公開記事が索引スコープに含まれないこと、feat-blog-top-page-compositionが所有するSearchAction/ItemListのJSON-LD生成そのものへの非侵犯境界の全チェックを証拠付きPASSにする。
...
- Dependencies: SYS-READER-SEARCH-QUALITY-P02
