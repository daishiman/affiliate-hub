---
graph_node_id: "SYS-READER-SEARCH-QUALITY-P10"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-reader-search-quality"
domain: "quality"
tags: ["p10","feat-reader-search-quality"]
priority: null
start_date: null
target_date: null
iteration: null
...
status: "active"
depends_on: ["SYS-READER-SEARCH-QUALITY-P09"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-reader-search-quality/final-review.md"]
purpose: "A1-A8の証跡、品質ゲート、feat-blog-top-page-compositionとのscope境界を独立した視点で最終判定する。"
goal: "A1-A8の証跡、品質ゲート、feat-blog-top-page-compositionとのscope境界を独立した視点で最終判定する。"
scope_in: ["Produced artifacts: final-review report","Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P09","Write scope/touches: docs/spec/feat-reader-search-quality/final-review.md"]
...
phase_ref: "P10"
file_path: "tasks/feat-reader-search-quality/sys-reader-search-quality-p10.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T04:37:54Z","origin_kind":"system-dev-planner","source_digest":"b55948e2e68707fa2a8b09dbfe1319c1b799fb956a2f6eaa4f667865b9534d5a","source_path":".dev-graph/published/feature-package-feat-reader-search-quality/task-specs/phase-10-final-review.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-reader-search-qualityのP10 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reader-search-quality/sys-reader-search-quality-p10.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-j6aw","github_mirror":null,"linked_at":"2026-09-04T07:34:03Z","sync_state":"linked"}
...
- parent_feature: feat-reader-search-quality
- phase_ref: P10
- classification: confidence=1.0; reason=feat-reader-search-qualityのP10 lifecycle責務への確定写像; candidate=tasks/feat-reader-search-quality/sys-reader-search-quality-p10.md
...
A1-A8の証跡、品質ゲート、feat-blog-top-page-compositionとのscope境界を独立した視点で最終判定する。

## 背景

読者が言葉から記事へ到達できるようにし、検索窓はあるのに index が無く実質使えない状態を解消する。現状の searchArticles ユースケースは published_articles の題名・要約に対する LIKE 部分一致に留まり、本文は検索されず関連度・新しさによる順位付けも無い。D1 上の FTS5 trigram 索引を公開記事から自動で保ち、日本語の部分一致でも妥当な順で結果が返り、検索結果面がサムネイル付きで表示され、JavaScript が無効でも検索が完了し、画面の検索と WebMCP 道具 searchArticles が同一ユースケースを通り、検索の入口が構造化データと llms.txt にも表れている状態にする。本phaseはSYS-READER-SEARCH-QUALITY-P09の確定成果物を入力にする。

## 前提条件

- Required spec/architecture/phase/task nodes: feat-reader-search-quality, spec-system-spec-index, arch-system-spec-overview, SYS-READER-SEARCH-QUALITY-P09
...
- Frontend: N/A: 実装検査はP07/P09で完了済み
- Backend: N/A: 実装検査はP07/P09で完了済み
- API: N/A: 実装検査はP07/P09で完了済み
- Data: applicable; P07/P09のdigest一致を確認する
- Infrastructure: N/A: 配備判断はP13が所有する
- Security: N/A: 実装検査はP09で完了済み
- Quality: applicable; A1-A8証跡欠落0とhigh finding 0を判定する
- Documentation: applicable; final-reviewを正本化する
- Operations: applicable; release blocker 0を確認する
...
- Produced artifacts: final-review report
- Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P09
- Write scope/touches: docs/spec/feat-reader-search-quality/final-review.md
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-READER-SEARCH-QUALITY-P10を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-READER-SEARCH-QUALITY-P10として割り当てる
- Worktree lease: 実装開始前にSYS-READER-SEARCH-QUALITY-P10をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence: docs/spec/feat-reader-search-quality/final-review.md
- Acceptance state: P10: A1-A8の証跡欠落0、high finding 0、P07/P09のdigest一致、feat-blog-top-page-compositionとのscope境界逸脱0、release blocker 0の場合のみreadiness=completeとし、それ以外はFAILと修正phaseを明記する。
...
- Rollout: final-review reportをwrite_scope内へ適用し、検証PASS後に依存する次phaseへ渡す
...
- Completion condition: P10: A1-A8の証跡欠落0、high finding 0、P07/P09のdigest一致、feat-blog-top-page-compositionとのscope境界逸脱0、release blocker 0の場合のみreadiness=completeとし、それ以外はFAILと修正phaseを明記する。
...
- Dependencies: SYS-READER-SEARCH-QUALITY-P09
