---
graph_node_id: "SYS-READER-SEARCH-QUALITY-P06"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-reader-search-quality"
domain: "quality"
tags: ["p06","feat-reader-search-quality"]
priority: null
start_date: null
target_date: null
iteration: null
title: "単体・結合・E2E・JavaScript無効・WebMCP契約テストの実行と緑化"
owners: ["daishiman"]
...
resource_scope: ["docs/spec/feat-reader-search-quality/test-run-report.md","test-results/feat-reader-search-quality/"]
purpose: "typecheck、content validation、unit、contract、DB integration、E2E、JavaScript無効E2E、WebMCP契約テストを実行し全て緑化する。"
goal: "typecheck、content validation、unit、contract、DB integration、E2E、JavaScript無効E2E、WebMCP契約テストを実行し全て緑化する。"
scope_in: ["Produced artifacts: test-run-report","Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P05","Write scope/touches: docs/spec/feat-reader-search-quality/test-run-report.md, test-results/feat-reader-search-quality/"]
...
phase_ref: "P06"
file_path: "tasks/feat-reader-search-quality/sys-reader-search-quality-p06.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T04:37:54Z","origin_kind":"system-dev-planner","source_digest":"b55948e2e68707fa2a8b09dbfe1319c1b799fb956a2f6eaa4f667865b9534d5a","source_path":".dev-graph/published/feature-package-feat-reader-search-quality/task-specs/phase-06-test-run.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-reader-search-qualityのP06 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reader-search-quality/sys-reader-search-quality-p06.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-2lok","github_mirror":null,"linked_at":"2026-09-04T07:33:54Z","sync_state":"linked"}
...
# System task overlay: 単体・結合・E2E・JavaScript無効・WebMCP契約テストの実行と緑化
...
- parent_feature: feat-reader-search-quality
- phase_ref: P06
- classification: confidence=1.0; reason=feat-reader-search-qualityのP06 lifecycle責務への確定写像; candidate=tasks/feat-reader-search-quality/sys-reader-search-quality-p06.md
...
typecheck、content validation、unit、contract、DB integration、E2E、JavaScript無効E2E、WebMCP契約テストを実行し全て緑化する。
...
- Frontend: applicable; JavaScript無効E2Eと検索結果面のbehaviorテストを実行する
- Backend: applicable; 索引追従・順位付けのunit/integrationテストを実行する
- API: applicable; URL契約とWebMCP契約テストを実行する
- Data: applicable; D1 integrationテストを実行する
- Infrastructure: applicable; IaC静的検証を実行する
- Security: applicable; FTS構文注入negativeテストを実行する
- Quality: applicable; 全suiteの失敗0を確認する
- Documentation: applicable; test-run-reportへ記録する
- Operations: applicable; D1障害retry演習を実行する
...
- Produced artifacts: test-run-report
...
- Write scope/touches: docs/spec/feat-reader-search-quality/test-run-report.md, test-results/feat-reader-search-quality/
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-READER-SEARCH-QUALITY-P06を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-READER-SEARCH-QUALITY-P06として割り当てる
- Worktree lease: 実装開始前にSYS-READER-SEARCH-QUALITY-P06をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence: docs/spec/feat-reader-search-quality/test-run-report.md, test-results/feat-reader-search-quality/
- Acceptance state: P06: typecheck、content validation、unit、contract、DB integration、E2E、JavaScript無効E2E、画面/WebMCP同一結果contractテストが失敗0件で、各command・exit・件数・artifact pathがtest-run-reportに記録される。
...
- Rollout: test-run-reportをwrite_scope内へ適用し、検証PASS後に依存する次phaseへ渡す
...
- Completion condition: P06: typecheck、content validation、unit、contract、DB integration、E2E、JavaScript無効E2E、画面/WebMCP同一結果contractテストが失敗0件で、各command・exit・件数・artifact pathがtest-run-reportに記録される。
