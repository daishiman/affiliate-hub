---
graph_node_id: "SYS-READER-SEARCH-QUALITY-P13"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-reader-search-quality"
domain: "operations"
tags: ["p13","feat-reader-search-quality"]
priority: null
start_date: null
target_date: null
iteration: null
...
status: "active"
depends_on: ["SYS-READER-SEARCH-QUALITY-P12"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-reader-search-quality/release-report.md","system-spec/backend.md","system-spec/database.md","system-spec/frontend.md","architecture/system-spec-overview.md"]
...
scope_in: ["Produced artifacts: release/rollback report、close-out receipt、canonical spec/architecture writeback","Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P12","Write scope/touches: docs/spec/feat-reader-search-quality/release-report.md, system-spec/backend.md, system-spec/database.md, system-spec/frontend.md, architecture/system-spec-overview.md"]
...
phase_ref: "P13"
file_path: "tasks/feat-reader-search-quality/sys-reader-search-quality-p13.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T04:37:54Z","origin_kind":"system-dev-planner","source_digest":"b55948e2e68707fa2a8b09dbfe1319c1b799fb956a2f6eaa4f667865b9534d5a","source_path":".dev-graph/published/feature-package-feat-reader-search-quality/task-specs/phase-13-release-deploy.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-reader-search-qualityのP13 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reader-search-quality/sys-reader-search-quality-p13.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-vrbn","github_mirror":null,"linked_at":"2026-09-04T07:34:10Z","sync_state":"linked"}
...
- parent_feature: feat-reader-search-quality
- phase_ref: P13
- classification: confidence=1.0; reason=feat-reader-search-qualityのP13 lifecycle責務への確定写像; candidate=tasks/feat-reader-search-quality/sys-reader-search-quality-p13.md
...
- Frontend: applicable; developmentの検索結果面/二経路入口をsmokeする
- Backend: applicable; 索引migration/検索usecaseをsmokeする
- API: applicable; live error taxonomyを確認する
- Data: applicable; D1結合とmigration状態を確認する
...
- Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P12
- Write scope/touches: docs/spec/feat-reader-search-quality/release-report.md, system-spec/backend.md, system-spec/database.md, system-spec/frontend.md, architecture/system-spec-overview.md
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-READER-SEARCH-QUALITY-P13を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-READER-SEARCH-QUALITY-P13として割り当てる
- Worktree lease: 実装開始前にSYS-READER-SEARCH-QUALITY-P13をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence: docs/spec/feat-reader-search-quality/release-report.md, system-spec/backend.md, system-spec/database.md, system-spec/frontend.md, architecture/system-spec-overview.md
- Acceptance state: P13: development deployment、smoke、FTS5索引反映・検索結果表示・WebMCP道具のtelemetry、rollback rehearsalがPASSし、本番releaseが未承認ならN/A理由を記録し、P13 spec/architecture writeback: required としてbackend・database・frontend・architectureの確定章へ実装差分と残findingをR4-reopen経由で反映しclose-out receiptを残す。
...
- Completion condition: P13: development deployment、smoke、FTS5索引反映・検索結果表示・WebMCP道具のtelemetry、rollback rehearsalがPASSし、本番releaseが未承認ならN/A理由を記録し、P13 spec/architecture writeback: required としてbackend・database・frontend・architectureの確定章へ実装差分と残findingをR4-reopen経由で反映しclose-out receiptを残す。
...
- Dependencies: SYS-READER-SEARCH-QUALITY-P12
