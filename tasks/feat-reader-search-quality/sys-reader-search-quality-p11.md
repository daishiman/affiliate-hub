---
graph_node_id: "SYS-READER-SEARCH-QUALITY-P11"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-reader-search-quality"
domain: "documentation"
tags: ["p11","feat-reader-search-quality"]
priority: null
start_date: null
target_date: null
iteration: null
title: "FTS5索引・日本語部分一致・順位付け・WebMCP同一結果証跡の再現可能な集約"
owners: ["daishiman"]
created_at: "2026-09-04T04:37:54Z"
updated_at: "2026-09-04T04:37:54Z"
status: "active"
depends_on: ["SYS-READER-SEARCH-QUALITY-P07","SYS-READER-SEARCH-QUALITY-P09","SYS-READER-SEARCH-QUALITY-P10"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-reader-search-quality/evidence/"]
purpose: "FTS5索引・日本語部分一致・順位付け・画面/WebMCP同一結果のtest/QA/acceptance verdictを一つのindexとmanifestへ集約し、第三者が再現できる状態にする。"
goal: "FTS5索引・日本語部分一致・順位付け・画面/WebMCP同一結果のtest/QA/acceptance verdictを一つのindexとmanifestへ集約し、第三者が再現できる状態にする。"
scope_in: ["Produced artifacts: evidence bundle、index、manifest、reproduction receipt","Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P07, SYS-READER-SEARCH-QUALITY-P09, SYS-READER-SEARCH-QUALITY-P10","Write scope/touches: docs/spec/feat-reader-search-quality/evidence/"]
...
phase_ref: "P11"
file_path: "tasks/feat-reader-search-quality/sys-reader-search-quality-p11.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T04:37:54Z","origin_kind":"system-dev-planner","source_digest":"b55948e2e68707fa2a8b09dbfe1319c1b799fb956a2f6eaa4f667865b9534d5a","source_path":".dev-graph/published/feature-package-feat-reader-search-quality/task-specs/phase-11-evidence.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-reader-search-qualityのP11 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reader-search-quality/sys-reader-search-quality-p11.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-ka9f","github_mirror":null,"linked_at":"2026-09-04T07:34:05Z","sync_state":"linked"}
...
# System task overlay: FTS5索引・日本語部分一致・順位付け・WebMCP同一結果証跡の再現可能な集約
...
- parent_feature: feat-reader-search-quality
- phase_ref: P11
- classification: confidence=1.0; reason=feat-reader-search-qualityのP11 lifecycle責務への確定写像; candidate=tasks/feat-reader-search-quality/sys-reader-search-quality-p11.md
...
FTS5索引・日本語部分一致・順位付け・画面/WebMCP同一結果のtest/QA/acceptance verdictを一つのindexとmanifestへ集約し、第三者が再現できる状態にする。

## 背景

読者が言葉から記事へ到達できるようにし、検索窓はあるのに index が無く実質使えない状態を解消する。現状の searchArticles ユースケースは published_articles の題名・要約に対する LIKE 部分一致に留まり、本文は検索されず関連度・新しさによる順位付けも無い。D1 上の FTS5 trigram 索引を公開記事から自動で保ち、日本語の部分一致でも妥当な順で結果が返り、検索結果面がサムネイル付きで表示され、JavaScript が無効でも検索が完了し、画面の検索と WebMCP 道具 searchArticles が同一ユースケースを通り、検索の入口が構造化データと llms.txt にも表れている状態にする。本phaseはSYS-READER-SEARCH-QUALITY-P07, SYS-READER-SEARCH-QUALITY-P09, SYS-READER-SEARCH-QUALITY-P10の確定成果物を入力にする。

## 前提条件

- Required spec/architecture/phase/task nodes: feat-reader-search-quality, spec-system-spec-index, arch-system-spec-overview, SYS-READER-SEARCH-QUALITY-P07, SYS-READER-SEARCH-QUALITY-P09, SYS-READER-SEARCH-QUALITY-P10
...
- Consumed artifacts: features/feat-reader-search-quality.md, features/feat-reader-search-quality.context.json, system-spec/backend.md, system-spec/database.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-READER-SEARCH-QUALITY-P07, SYS-READER-SEARCH-QUALITY-P09, SYS-READER-SEARCH-QUALITY-P10
- Write scope/touches: docs/spec/feat-reader-search-quality/evidence/
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-READER-SEARCH-QUALITY-P11を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-READER-SEARCH-QUALITY-P11として割り当てる
- Worktree lease: 実装開始前にSYS-READER-SEARCH-QUALITY-P11をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence: docs/spec/feat-reader-search-quality/evidence/
- Acceptance state: P11: evidence/index.jsonがFTS5索引migration・公開状態追随・日本語部分一致・順位付け・画面/WebMCP同一結果・JavaScript無効完走・P06/P07/P09/P10の証跡をpath・digest・取得日時・tool versionで参照し、missing/duplicate/stale 0、再実行commandがexit0になる。
...
- Completion condition: P11: evidence/index.jsonがFTS5索引migration・公開状態追随・日本語部分一致・順位付け・画面/WebMCP同一結果・JavaScript無効完走・P06/P07/P09/P10の証跡をpath・digest・取得日時・tool versionで参照し、missing/duplicate/stale 0、再実行commandがexit0になる。
...
- Dependencies: SYS-READER-SEARCH-QUALITY-P07, SYS-READER-SEARCH-QUALITY-P09, SYS-READER-SEARCH-QUALITY-P10
