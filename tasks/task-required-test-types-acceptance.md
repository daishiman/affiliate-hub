---
graph_node_id: "task-required-test-types-acceptance"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "必須テスト種別を宣言する（受け入れ条件 8 件）"
owners: ["daishiman"]
created_at: "2026-08-17T22:00:00Z"
updated_at: "2026-09-08T07:19:28.816761Z"
status: "draft"
...
purpose: null
goal: null
mvp_alignment: {"background":"240 要件のうち必須テスト種別を宣言できているのは 12 件だけで、受け入れ条件の 8 件は未宣言のまま","mvp_fit":"enabling","purpose":"受け入れ条件の 8 件について、必要なテスト種別を 1 件ずつ決める","rationale":"種別を決めないとテストは書きやすいところから書かれ、権限のできてはいけない側・禁止された状態遷移・障害注入が永久に残る"}
scope_in: []
scope_out: []
acceptance: []
architecture_refs: []
...
phase_ref: null
file_path: "tasks/task-required-test-types-acceptance.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/task-required-test-types-acceptance.md","confidence":0.95}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-zs0","github_mirror":null,"linked_at":"2026-09-08T07:14:07Z","sync_state":"linked"}
...
そこで**文脈ごと**に分けた。この課題はそのうちの 1 つで、8 件だけを見ればよい。
...
`REQ-A01` `REQ-A02` `REQ-A03` `REQ-A04` `REQ-A05` `REQ-A06` `REQ-A07` `REQ-A08`
...
- 対象 8 件すべてに、宣言か理由つき除外がある
- `node scripts/required-test-types.mjs` が緑
- `TEST_TYPES_MAX_UNDECLARED` が 8 件ぶん下がっている
