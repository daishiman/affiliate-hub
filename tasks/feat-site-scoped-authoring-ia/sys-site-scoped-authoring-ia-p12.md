---
graph_node_id: "SYS-SITE-SCOPED-AUTHORING-IA-P12"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-site-scoped-authoring-ia"
domain: "documentation"
tags: ["p12","feat-site-scoped-authoring-ia"]
priority: null
start_date: null
target_date: null
iteration: null
title: "所属替え・束ね直しの運用規則と運用手順の文書化"
owners: ["daishiman"]
created_at: "2026-09-08T04:15:58Z"
updated_at: "2026-09-09T00:00:00Z"
status: "active"
depends_on: ["SYS-SITE-SCOPED-AUTHORING-IA-P10","SYS-SITE-SCOPED-AUTHORING-IA-P11"]
related_nodes: []
resource_scope: ["docs/spec/feat-site-scoped-authoring-ia/ia-rules.md","docs/spec/feat-site-scoped-authoring-ia/operations.md"]
purpose: "所属替え後の入口束ね直しの保守規則、書き方の決め事の共通雛形からの複製手順、よく使う画面への近道の編集手順、新規ブログ追加時に読者像・書き方の決め事が自動的に所属替え済みの配下へ収まることを確認する手順が文書化された状態を成立させる。"
goal: "所属替え後の入口束ね直しの保守規則、書き方の決め事の共通雛形からの複製手順、よく使う画面への近道の編集手順、新規ブログ追加時に読者像・書き方の決め事が自動的に所属替え済みの配下へ収まることを確認する手順が文書化された状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/ia-rules.md (入口束ね直し・動詞ラベル適用・危険操作分離の保守規則); docs/spec/feat-site-scoped-authoring-ia/operations.md (雛形複製手順・近道編集手順・新規ブログ追加時の所属替え確認手順)","Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/final-review.md, docs/spec/feat-site-scoped-authoring-ia/evidence/","Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/ia-rules.md, docs/spec/feat-site-scoped-authoring-ia/operations.md"]
...
acceptance: ["Automated commands: `pnpm run typecheck`","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-site-scoped-authoring-ia` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P12 の 成果物 section に記載した produced artifacts のパス"]
...
phase_ref: "P12"
file_path: "tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p12.md"
template_id: "task"
...
classification_reason: "feat-site-scoped-authoring-ia の P12 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p12.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-ro3w.12","github_mirror":null,"linked_at":"2026-09-08T05:32:49Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-08T11:56:46Z","evidence_refs":["beads:ah-ro3w.12"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
implementation_readiness: {"checked_at":"2026-09-08T00:00:00Z","missing_sections":[],"status":"complete"}
---

# System task overlay: 所属替え・束ね直しの運用規則と運用手順の文書化
...
- parent_feature: feat-site-scoped-authoring-ia
- phase_ref: P12
- classification: confidence=1.0; reason=feat-site-scoped-authoring-ia の P12 lifecycle 責務への確定写像; candidate=tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p12.md
...
所属替え後の入口束ね直しの保守規則、書き方の決め事の共通雛形からの複製手順、よく使う画面への近道の編集手順、新規ブログ追加時に読者像・書き方の決め事が自動的に所属替え済みの配下へ収まることを確認する手順が文書化された状態を成立させる。
...
- P12 upstream entry gate: SYS-SITE-SCOPED-AUTHORING-IA-P10 の implementation_readiness=complete と SYS-SITE-SCOPED-AUTHORING-IA-P11 の implementation_readiness=complete
...
- Frontend: N/A: 運用文書化であり新規実装を伴わない
...
- Security: N/A: 権限運用の変更を伴わない
- Quality: N/A: P09/P10の検査結果を参照するのみで新規検査は行わない
- Documentation: applicable; 運用規則・運用手順の文書化そのものが本 phase の成果物である
- Operations: applicable; 雛形複製・近道編集・新規ブログ追加時の所属替え確認の運用手順を確定する
...
- Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/ia-rules.md (入口束ね直し・動詞ラベル適用・危険操作分離の保守規則); docs/spec/feat-site-scoped-authoring-ia/operations.md (雛形複製手順・近道編集手順・新規ブログ追加時の所属替え確認手順)
- Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/final-review.md, docs/spec/feat-site-scoped-authoring-ia/evidence/
- Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/ia-rules.md, docs/spec/feat-site-scoped-authoring-ia/operations.md
...
- PR body contract: Closes #issue (beads issue) + dev-graph graph_node_id=SYS-SITE-SCOPED-AUTHORING-IA-P12; PR の宛先は dev ブランチとする
- Ownership boundary: system-dev-plannerはintentのみを宣言し、dev-graphがtracker mutationとreconciliationを行う

## Branch and worktree execution

- Branch: assigned after dev-graph registration by C15 as devgraph/SYS-SITE-SCOPED-AUTHORING-IA-P12; system-dev-plannerは事前割当を行わない
- Worktree lease: claim SYS-SITE-SCOPED-AUTHORING-IA-P12 before implementation; heartbeat/release は dev-graph worktree lease 契約に従う
...
- Goal: 所属替え後の入口束ね直しの保守規則、書き方の決め事の共通雛形からの複製手順、よく使う画面への近道の編集手順、新規ブログ追加時に読者像・書き方の決め事が自動的に所属替え済みの配下へ収まることを確認する手順が文書化された状態を成立させる。
- Generic execution prompt: feat-site-scoped-authoring-ia の goal (読者像と書き方の決め事が /admin/sites/[site]/ 配下に属し、93 本ある管理ルートが作業の対象物 (ブログ・記事・読者・商品・配信) の数まで畳まれ、各入口の名前から何ができるかが分かり、/admin/content/* と /admin/personas/* と /admin/writing/* が転送で受けられている状態になっている) と本 task の 前提条件/成果物/write_scope/スコープ外 を渡し、実装手段は固定せず P12 の目的を満たす成果物を作らせる
...
- Dependencies: SYS-SITE-SCOPED-AUTHORING-IA-P10, SYS-SITE-SCOPED-AUTHORING-IA-P11
