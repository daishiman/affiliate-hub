---
graph_node_id: "SYS-SITE-SCOPED-AUTHORING-IA-P10"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-site-scoped-authoring-ia"
domain: "quality"
tags: ["p10","feat-site-scoped-authoring-ia"]
priority: null
start_date: null
target_date: null
iteration: null
...
status: "active"
depends_on: ["SYS-SITE-SCOPED-AUTHORING-IA-P09"]
related_nodes: []
resource_scope: ["docs/spec/feat-site-scoped-authoring-ia/final-review.md"]
purpose: "P01からP09の成果を通しでレビューし、受入10件 (A1-A10) の充足判定と、未充足があれば残課題が確定した状態を成立させる。"
goal: "P01からP09の成果を通しでレビューし、受入10件 (A1-A10) の充足判定と、未充足があれば残課題が確定した状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/final-review.md","Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/acceptance-report.md, docs/spec/feat-site-scoped-authoring-ia/quality-report.md","Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/final-review.md"]
...
acceptance: ["Automated commands: `pnpm run typecheck`","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-site-scoped-authoring-ia` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P10 の 成果物 section に記載した produced artifacts のパス"]
...
phase_ref: "P10"
file_path: "tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p10.md"
template_id: "task"
...
classification_reason: "feat-site-scoped-authoring-ia の P10 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p10.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-ro3w.10","github_mirror":null,"linked_at":"2026-09-08T05:32:45Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-08T11:37:59Z","evidence_refs":["beads:ah-ro3w.10"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
...
- parent_feature: feat-site-scoped-authoring-ia
- phase_ref: P10
- classification: confidence=1.0; reason=feat-site-scoped-authoring-ia の P10 lifecycle 責務への確定写像; candidate=tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p10.md
...
P01からP09の成果を通しでレビューし、受入10件 (A1-A10) の充足判定と、未充足があれば残課題が確定した状態を成立させる。
...
- P10 upstream entry gate: SYS-SITE-SCOPED-AUTHORING-IA-P09 の implementation_readiness=complete
...
- Frontend: applicable; P01-P09の成果を通しでレビューする
...
- Security: N/A: P09の検査結果を参照するのみで新規検査は行わない
- Quality: applicable; A1-A10の充足判定と残課題確定を完了条件とする
- Documentation: applicable; 最終レビュー文書そのものが本 phase の成果物である
...
- Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/final-review.md
...
- Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/final-review.md
...
- PR body contract: Closes #issue (beads issue) + dev-graph graph_node_id=SYS-SITE-SCOPED-AUTHORING-IA-P10; PR の宛先は dev ブランチとする
- Ownership boundary: system-dev-plannerはintentのみを宣言し、dev-graphがtracker mutationとreconciliationを行う

## Branch and worktree execution

- Branch: assigned after dev-graph registration by C15 as devgraph/SYS-SITE-SCOPED-AUTHORING-IA-P10; system-dev-plannerは事前割当を行わない
- Worktree lease: claim SYS-SITE-SCOPED-AUTHORING-IA-P10 before implementation; heartbeat/release は dev-graph worktree lease 契約に従う
...
- Goal: P01からP09の成果を通しでレビューし、受入10件 (A1-A10) の充足判定と、未充足があれば残課題が確定した状態を成立させる。
- Generic execution prompt: feat-site-scoped-authoring-ia の goal (読者像と書き方の決め事が /admin/sites/[site]/ 配下に属し、93 本ある管理ルートが作業の対象物 (ブログ・記事・読者・商品・配信) の数まで畳まれ、各入口の名前から何ができるかが分かり、/admin/content/* と /admin/personas/* と /admin/writing/* が転送で受けられている状態になっている) と本 task の 前提条件/成果物/write_scope/スコープ外 を渡し、実装手段は固定せず P10 の目的を満たす成果物を作らせる
...
- Dependencies: SYS-SITE-SCOPED-AUTHORING-IA-P09
