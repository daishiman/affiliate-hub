---
graph_node_id: "SYS-SITE-SCOPED-AUTHORING-IA-P09"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "品質保証とアクセシビリティ・危険操作分離の非機能検査"
owners: ["daishiman"]
created_at: "2026-09-08T04:15:58Z"
updated_at: "2026-09-09T00:00:00Z"
status: "active"
depends_on: ["SYS-SITE-SCOPED-AUTHORING-IA-P08"]
related_nodes: []
resource_scope: ["docs/spec/feat-site-scoped-authoring-ia/quality-report.md"]
purpose: "型検査・lint・axe-core (重大違反0件)・動詞ラベルの正答率調査 (90%以上)・危険操作の確認分岐検査・応答性能検査が基準を満たし、結果が記録された状態を成立させる。"
goal: "型検査・lint・axe-core (重大違反0件)・動詞ラベルの正答率調査 (90%以上)・危険操作の確認分岐検査・応答性能検査が基準を満たし、結果が記録された状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/quality-report.md","Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/migration-report.md","Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/quality-report.md"]
...
acceptance: ["Automated commands: `pnpm run typecheck`","Automated commands: `pnpm run lint`","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-site-scoped-authoring-ia` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P09 の 成果物 section に記載した produced artifacts のパス"]
...
phase_ref: "P09"
file_path: "tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p09.md"
template_id: "task"
...
classification_reason: "feat-site-scoped-authoring-ia の P09 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p09.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-ro3w.9","github_mirror":null,"linked_at":"2026-09-08T05:32:43Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-08T11:36:34Z","evidence_refs":["beads:ah-ro3w.9"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
