---
graph_node_id: "SYS-SITE-SCOPED-AUTHORING-IA-P11"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-site-scoped-authoring-ia"
domain: "documentation"
tags: ["p11","feat-site-scoped-authoring-ia"]
priority: null
start_date: null
target_date: null
iteration: null
...
status: "active"
depends_on: ["SYS-SITE-SCOPED-AUTHORING-IA-P07","SYS-SITE-SCOPED-AUTHORING-IA-P09"]
related_nodes: []
resource_scope: ["docs/spec/feat-site-scoped-authoring-ia/evidence/"]
purpose: "P07の受入判定証跡とP09の品質検査証跡をdocs/spec/feat-site-scoped-authoring-ia/evidence/ 配下へ集約し、再現手順を含めて第三者が検証できる状態を成立させる。"
goal: "P07の受入判定証跡とP09の品質検査証跡をdocs/spec/feat-site-scoped-authoring-ia/evidence/ 配下へ集約し、再現手順を含めて第三者が検証できる状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/evidence/","Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/acceptance-report.md, docs/spec/feat-site-scoped-authoring-ia/quality-report.md","Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/evidence/"]
...
acceptance: ["Automated commands: `pnpm run typecheck`","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-site-scoped-authoring-ia` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P11 の 成果物 section に記載した produced artifacts のパス"]
...
phase_ref: "P11"
file_path: "tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p11.md"
template_id: "task"
...
classification_reason: "feat-site-scoped-authoring-ia の P11 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p11.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-ro3w.11","github_mirror":null,"linked_at":"2026-09-08T05:32:47Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-08T11:52:36Z","evidence_refs":["beads:ah-ro3w.11"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
...
- parent_feature: feat-site-scoped-authoring-ia
- phase_ref: P11
- classification: confidence=1.0; reason=feat-site-scoped-authoring-ia の P11 lifecycle 責務への確定写像; candidate=tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p11.md
...
P07の受入判定証跡とP09の品質検査証跡をdocs/spec/feat-site-scoped-authoring-ia/evidence/ 配下へ集約し、再現手順を含めて第三者が検証できる状態を成立させる。
...
- P11 upstream entry gate: SYS-SITE-SCOPED-AUTHORING-IA-P07 の implementation_readiness=complete と SYS-SITE-SCOPED-AUTHORING-IA-P09 の implementation_readiness=complete
...
- Security: N/A: 証跡集約であり新規検査を伴わない
- Quality: applicable; 証跡が第三者検証可能な形で揃うことを完了条件とする
- Documentation: applicable; 証跡集約文書そのものが本 phase の成果物である
...
- Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/evidence/
- Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/acceptance-report.md, docs/spec/feat-site-scoped-authoring-ia/quality-report.md
- Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/evidence/
...
- PR body contract: Closes #issue (beads issue) + dev-graph graph_node_id=SYS-SITE-SCOPED-AUTHORING-IA-P11; PR の宛先は dev ブランチとする
- Ownership boundary: system-dev-plannerはintentのみを宣言し、dev-graphがtracker mutationとreconciliationを行う

## Branch and worktree execution

- Branch: assigned after dev-graph registration by C15 as devgraph/SYS-SITE-SCOPED-AUTHORING-IA-P11; system-dev-plannerは事前割当を行わない
- Worktree lease: claim SYS-SITE-SCOPED-AUTHORING-IA-P11 before implementation; heartbeat/release は dev-graph worktree lease 契約に従う
...
- Goal: P07の受入判定証跡とP09の品質検査証跡をdocs/spec/feat-site-scoped-authoring-ia/evidence/ 配下へ集約し、再現手順を含めて第三者が検証できる状態を成立させる。
- Generic execution prompt: feat-site-scoped-authoring-ia の goal (読者像と書き方の決め事が /admin/sites/[site]/ 配下に属し、93 本ある管理ルートが作業の対象物 (ブログ・記事・読者・商品・配信) の数まで畳まれ、各入口の名前から何ができるかが分かり、/admin/content/* と /admin/personas/* と /admin/writing/* が転送で受けられている状態になっている) と本 task の 前提条件/成果物/write_scope/スコープ外 を渡し、実装手段は固定せず P11 の目的を満たす成果物を作らせる
...
- Dependencies: SYS-SITE-SCOPED-AUTHORING-IA-P07, SYS-SITE-SCOPED-AUTHORING-IA-P09
