---
graph_node_id: "SYS-SITE-SCOPED-AUTHORING-IA-P03"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-site-scoped-authoring-ia"
domain: "quality"
tags: ["p03","feat-site-scoped-authoring-ia"]
priority: null
start_date: null
target_date: null
iteration: null
title: "設計レビューと転送網羅性・越境防止・ラベル整合性の独立検証"
owners: ["daishiman"]
created_at: "2026-09-08T04:15:58Z"
updated_at: "2026-09-09T00:00:00Z"
status: "active"
depends_on: ["SYS-SITE-SCOPED-AUTHORING-IA-P02"]
related_nodes: []
resource_scope: ["docs/spec/feat-site-scoped-authoring-ia/design-review.md"]
purpose: "P02の設計契約に対する独立レビューを完了し、旧URL転送の網羅性、他ブログの内容を出さない越境防止設計、動詞ラベルの feat-reference-blog-admin-ux 規則との整合性、危険操作分離の分岐設計の各観点の指摘が設計へ反映されるか残課題として明示された状態を成立させる。"
goal: "P02の設計契約に対する独立レビューを完了し、旧URL転送の網羅性、他ブログの内容を出さない越境防止設計、動詞ラベルの feat-reference-blog-admin-ux 規則との整合性、危険操作分離の分岐設計の各観点の指摘が設計へ反映されるか残課題として明示された状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/design-review.md","Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/redirect-contract.md, docs/spec/feat-site-scoped-authoring-ia/site-scoped-route-contract.md, docs/spec/feat-site-scoped-authoring-ia/entry-consolidation-contract.md, docs/spec/feat-site-scoped-authoring-ia/shortcut-contract.md, docs/spec/feat-site-scoped-authoring-ia/template-clone-contract.md","Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/design-review.md"]
...
acceptance: ["Automated commands: `pnpm run typecheck`","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-site-scoped-authoring-ia` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P03 の 成果物 section に記載した produced artifacts のパス"]
...
phase_ref: "P03"
file_path: "tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p03.md"
template_id: "task"
...
classification_reason: "feat-site-scoped-authoring-ia の P03 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p03.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-ro3w.3","github_mirror":null,"linked_at":"2026-09-08T05:32:30Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-08T09:35:56Z","evidence_refs":["beads:ah-ro3w.3"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
implementation_readiness: {"checked_at":"2026-09-08T00:00:00Z","missing_sections":[],"status":"complete"}
---

# System task overlay: 設計レビューと転送網羅性・越境防止・ラベル整合性の独立検証
...
- parent_feature: feat-site-scoped-authoring-ia
- phase_ref: P03
- classification: confidence=1.0; reason=feat-site-scoped-authoring-ia の P03 lifecycle 責務への確定写像; candidate=tasks/feat-site-scoped-authoring-ia/sys-site-scoped-authoring-ia-p03.md
...
P02の設計契約に対する独立レビューを完了し、旧URL転送の網羅性、他ブログの内容を出さない越境防止設計、動詞ラベルの feat-reference-blog-admin-ux 規則との整合性、危険操作分離の分岐設計の各観点の指摘が設計へ反映されるか残課題として明示された状態を成立させる。
...
- P03 upstream entry gate: SYS-SITE-SCOPED-AUTHORING-IA-P02 の implementation_readiness=complete
...
- Frontend: applicable; 契約群のレビューを行う
...
- Security: applicable; 越境防止設計 (site 未解決時 notFound、他ブログ内容非表示) の妥当性をレビューする
- Quality: applicable; レビュー指摘の残課題明示を完了条件とする
- Documentation: applicable; レビュー結果文書そのものが本 phase の成果物である
...
- Produced artifacts: docs/spec/feat-site-scoped-authoring-ia/design-review.md
- Consumed artifacts: docs/spec/feat-site-scoped-authoring-ia/redirect-contract.md, docs/spec/feat-site-scoped-authoring-ia/site-scoped-route-contract.md, docs/spec/feat-site-scoped-authoring-ia/entry-consolidation-contract.md, docs/spec/feat-site-scoped-authoring-ia/shortcut-contract.md, docs/spec/feat-site-scoped-authoring-ia/template-clone-contract.md
- Write scope/touches: docs/spec/feat-site-scoped-authoring-ia/design-review.md
...
- PR body contract: Closes #issue (beads issue) + dev-graph graph_node_id=SYS-SITE-SCOPED-AUTHORING-IA-P03; PR の宛先は dev ブランチとする
- Ownership boundary: system-dev-plannerはintentのみを宣言し、dev-graphがtracker mutationとreconciliationを行う

## Branch and worktree execution

- Branch: assigned after dev-graph registration by C15 as devgraph/SYS-SITE-SCOPED-AUTHORING-IA-P03; system-dev-plannerは事前割当を行わない
- Worktree lease: claim SYS-SITE-SCOPED-AUTHORING-IA-P03 before implementation; heartbeat/release は dev-graph worktree lease 契約に従う
...
- Goal: P02の設計契約に対する独立レビューを完了し、旧URL転送の網羅性、他ブログの内容を出さない越境防止設計、動詞ラベルの feat-reference-blog-admin-ux 規則との整合性、危険操作分離の分岐設計の各観点の指摘が設計へ反映されるか残課題として明示された状態を成立させる。
- Generic execution prompt: feat-site-scoped-authoring-ia の goal (読者像と書き方の決め事が /admin/sites/[site]/ 配下に属し、93 本ある管理ルートが作業の対象物 (ブログ・記事・読者・商品・配信) の数まで畳まれ、各入口の名前から何ができるかが分かり、/admin/content/* と /admin/personas/* と /admin/writing/* が転送で受けられている状態になっている) と本 task の 前提条件/成果物/write_scope/スコープ外 を渡し、実装手段は固定せず P03 の目的を満たす成果物を作らせる
...
- Dependencies: SYS-SITE-SCOPED-AUTHORING-IA-P02
