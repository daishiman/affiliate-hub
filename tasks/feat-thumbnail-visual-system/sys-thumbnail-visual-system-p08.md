---
graph_node_id: "SYS-THUMBNAIL-VISUAL-SYSTEM-P08"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "既存記事一覧・関連記事コンポーネントとの重複解消と移行"
owners: ["daishiman"]
...
resource_scope: ["src/db/schema.ts","drizzle/","src/domain/blogops/","src/application/usecases/blog-ops/","src/infrastructure/persistence/d1/","src/presentation/site/","src/presentation/admin/","docs/spec/feat-thumbnail-visual-system/migration-report.md"]
purpose: "既存の記事一覧・関連記事表示コンポーネントを正本化し、追加実装との二重component・二重tableを解消して後方互換migrationを完了する。"
goal: "既存の記事一覧・関連記事表示コンポーネントを正本化し、追加実装との二重component・二重tableを解消して後方互換migrationを完了する。"
scope_in: ["Produced artifacts: 後方互換migration、adapter/redirect、重複解消、migration report","Consumed artifacts: features/feat-thumbnail-visual-system.md, features/feat-thumbnail-visual-system.context.json, system-spec/ui-ux.md, system-spec/frontend.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-THUMBNAIL-VISUAL-SYSTEM-P05","Write scope/touches: src/db/schema.ts, drizzle/, src/domain/blogops/, src/application/usecases/blog-ops/, src/infrastructure/persistence/d1/, src/presentation/site/, src/presentation/admin/, docs/spec/feat-thumbnail-visual-system/migration-report.md"]
...
phase_ref: "P08"
file_path: "tasks/feat-thumbnail-visual-system/sys-thumbnail-visual-system-p08.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T04:16:11Z","origin_kind":"system-dev-planner","source_digest":"3495330b8d67c78fac526b7468ec270cb6f15e6e8c07d88d6e80dd526d37109d","source_path":".dev-graph/published/feature-package-feat-thumbnail-visual-system/task-specs/phase-08-refactoring-migration.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-thumbnail-visual-systemのP08 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-thumbnail-visual-system/sys-thumbnail-visual-system-p08.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-a4m8","github_mirror":null,"linked_at":"2026-09-04T07:33:29Z","sync_state":"linked"}
