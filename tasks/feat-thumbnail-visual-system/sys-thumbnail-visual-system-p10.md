---
graph_node_id: "SYS-THUMBNAIL-VISUAL-SYSTEM-P10"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-thumbnail-visual-system"
domain: "quality"
tags: ["p10","feat-thumbnail-visual-system"]
priority: null
start_date: null
target_date: null
iteration: null
...
status: "active"
depends_on: ["SYS-THUMBNAIL-VISUAL-SYSTEM-P09"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-thumbnail-visual-system/final-review.md"]
purpose: "P01のbaseline、P03 design verdict、P07 acceptance、P09 QAを同じA1-A7とcurrent bytesで突合し、実装完了判定を生成者から独立して下す。"
goal: "P01のbaseline、P03 design verdict、P07 acceptance、P09 QAを同じA1-A7とcurrent bytesで突合し、実装完了判定を生成者から独立して下す。"
scope_in: ["Produced artifacts: digest-bound independent final review","Consumed artifacts: features/feat-thumbnail-visual-system.md, features/feat-thumbnail-visual-system.context.json, system-spec/ui-ux.md, system-spec/frontend.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-THUMBNAIL-VISUAL-SYSTEM-P09","Write scope/touches: docs/spec/feat-thumbnail-visual-system/final-review.md"]
...
source_lineage: {"imported_at":"2026-09-04T04:16:11Z","origin_kind":"system-dev-planner","source_digest":"3495330b8d67c78fac526b7468ec270cb6f15e6e8c07d88d6e80dd526d37109d","source_path":".dev-graph/published/feature-package-feat-thumbnail-visual-system/task-specs/phase-10-final-review.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-thumbnail-visual-systemのP10 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-thumbnail-visual-system/sys-thumbnail-visual-system-p10.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-gxp6","github_mirror":null,"linked_at":"2026-09-04T07:33:33Z","sync_state":"linked"}
...
- parent_feature: feat-thumbnail-visual-system
- phase_ref: P10
- classification: confidence=1.0; reason=feat-thumbnail-visual-systemのP10 lifecycle責務への確定写像; candidate=tasks/feat-thumbnail-visual-system/sys-thumbnail-visual-system-p10.md
...
P01のbaseline、P03 design verdict、P07 acceptance、P09 QAを同じA1-A7とcurrent bytesで突合し、実装完了判定を生成者から独立して下す。

## 背景

記事・ブログ・管理画面のどの一覧でも内容を一目で識別できるサムネイルが必ず表示され、画像が無いことによる空白や版面のずれが起きないようにする。記事編集での明示アップロード・アイキャッチ指定・本文先頭画像の優先順位で登録し、いずれも無い場合はタイトル・カテゴリー・ブログ配色トークンから外部接続なしで決定論的に代替図版を生成する。R2へオリジナルと16:9派生(複数幅)を保存し、トップページ・記事一覧・カテゴリー・タグ・検索結果・関連記事・管理画面のブログ一覧/記事一覧/プレビューの全画面へ配信する。サムネイル・代替図版・アイコンに限りCLS 0.1未満を満たし、OGP/Twitter Card(summary_large_image)へ再利用する。本phaseはSYS-THUMBNAIL-VISUAL-SYSTEM-P09の確定成果物を入力にする。

## 前提条件

- Required spec/architecture/phase/task nodes: feat-thumbnail-visual-system, spec-system-spec-index, arch-system-spec-overview, SYS-THUMBNAIL-VISUAL-SYSTEM-P09
...
- Backend: applicable; 代替図版生成と保存結果をレビューする
- API: applicable; R2派生contract evidenceをレビューする
- Data: applicable; DB結合・migration evidenceをレビューする
- Infrastructure: applicable; IaC/smoke evidenceをレビューする
- Security: applicable; 外部接続なしevidenceをレビューする
- Quality: applicable; C1-C4とA1-A7を独立採点する
...
- Consumed artifacts: features/feat-thumbnail-visual-system.md, features/feat-thumbnail-visual-system.context.json, system-spec/ui-ux.md, system-spec/frontend.md, system-spec/retrieval-evidence/kajetblog-top-analysis.md, SYS-THUMBNAIL-VISUAL-SYSTEM-P09
- Write scope/touches: docs/spec/feat-thumbnail-visual-system/final-review.md
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-THUMBNAIL-VISUAL-SYSTEM-P10を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-THUMBNAIL-VISUAL-SYSTEM-P10として割り当てる
- Worktree lease: 実装開始前にSYS-THUMBNAIL-VISUAL-SYSTEM-P10をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence: docs/spec/feat-thumbnail-visual-system/final-review.md
- Acceptance state: P10: A1-A7の証跡欠落0、high finding 0、P07/P09のdigest一致、feat-reader-surfaceとのscope境界逸脱0、release blocker 0の場合のみreadiness=completeとし、それ以外はFAILと修正phaseを明記する。
...
- Completion condition: P10: A1-A7の証跡欠落0、high finding 0、P07/P09のdigest一致、feat-reader-surfaceとのscope境界逸脱0、release blocker 0の場合のみreadiness=completeとし、それ以外はFAILと修正phaseを明記する。
...
- Dependencies: SYS-THUMBNAIL-VISUAL-SYSTEM-P09
