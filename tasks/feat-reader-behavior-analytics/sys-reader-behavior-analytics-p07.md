---
graph_node_id: "SYS-READER-BEHAVIOR-ANALYTICS-P07"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "読者行動計測の受入10件の判定"
owners: ["daishiman"]
created_at: "2026-09-03T23:47:24Z"
updated_at: "2026-09-09T00:00:00Z"
status: "closed"
depends_on: ["SYS-READER-BEHAVIOR-ANALYTICS-P06"]
related_nodes: []
resource_scope: ["docs/spec/feat-reader-behavior-analytics/acceptance-report.md"]
purpose: "feat-reader-behavior-analytics の受入10件を1件ずつ証跡付きで判定し、すべて満たされていることを確定した状態を成立させる。"
goal: "feat-reader-behavior-analytics の受入10件を1件ずつ証跡付きで判定し、すべて満たされていることを確定した状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-reader-behavior-analytics/acceptance-report.md (受入10件の判定と証跡参照)","Consumed artifacts: features/feat-reader-behavior-analytics.md; features/feat-reader-behavior-analytics.context.json; system-spec/frontend.md; system-spec/database.md; system-spec/security.md","Write scope/touches: docs/spec/feat-reader-behavior-analytics/acceptance-report.md"]
scope_out: ["1 読者の行動を時系列で再生する機能 (作らない)","日次ロールアップと収益・PV との突合 (feat-blog-metrics-rollup が所有する)","行動指標を使った示唆生成と提示順序 (feat-blog-scoped-admin-console が所有する)","既存の汎用イベント/KPI 基盤そのもの (feat-analytics-insight が所有する)","P07 以外の phase が所有する成果物への変更"]
...
phase_ref: "P07"
file_path: "tasks/feat-reader-behavior-analytics/sys-reader-behavior-analytics-p07.md"
template_id: "task"
...
classification_reason: "feat-reader-behavior-analytics の P07 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reader-behavior-analytics/sys-reader-behavior-analytics-p07.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-f4do.7","github_mirror":null,"linked_at":"2026-09-04T02:06:55Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T10:31:11Z","evidence_refs":["beads:ah-f4do.7"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
