---
graph_node_id: "task-required-test-types-content"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "必須テスト種別を宣言する（記事構成・文章と品質検査 23 件）"
owners: ["daishiman"]
created_at: "2026-08-17T22:00:00Z"
updated_at: "2026-09-08T07:19:55.051853Z"
status: "draft"
...
purpose: null
goal: null
mvp_alignment: {"background":"240 要件のうち必須テスト種別を宣言できているのは 12 件だけで、記事構成・文章と品質検査の 23 件は未宣言のまま","mvp_fit":"enabling","purpose":"記事構成・文章と品質検査の 23 件について、必要なテスト種別を 1 件ずつ決める","rationale":"種別を決めないとテストは書きやすいところから書かれ、権限のできてはいけない側・禁止された状態遷移・障害注入が永久に残る"}
scope_in: []
scope_out: []
acceptance: []
architecture_refs: []
...
phase_ref: null
file_path: "tasks/task-required-test-types-content.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/task-required-test-types-content.md","confidence":0.95}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-fh8","github_mirror":null,"linked_at":"2026-09-08T07:14:07Z","sync_state":"linked"}
...
そこで**文脈ごと**に分けた。この課題はそのうちの 1 つで、23 件だけを見ればよい。
...
対象の要件 23 件（**記事構成・文章と品質検査**）:

`REQ-QC01` `REQ-QC02` `REQ-QC03` `REQ-QC04` `REQ-QC05` `REQ-QC06` `REQ-QC07` `REQ-QC08` `REQ-QC09` `REQ-QC10` `REQ-QC11` `REQ-W01` `REQ-W02` `REQ-W03` `REQ-W04` `REQ-W05` `REQ-W06` `REQ-W07` `REQ-W08` `REQ-W09` `REQ-W10` `REQ-W11` `REQ-W12`
...
1. 対象 23 件を 1 件ずつ**中身を読んで**、性質を決める
...
- 対象 23 件すべてに、宣言か理由つき除外がある
- `node scripts/required-test-types.mjs` が緑
- `TEST_TYPES_MAX_UNDECLARED` が 23 件ぶん下がっている
