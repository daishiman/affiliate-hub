---
graph_node_id: "SYS-SEO-AEO-MEASUREMENT-LOOP-P13"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-seo-aeo-measurement-loop"
domain: "operations"
tags: ["p13","feat-seo-aeo-measurement-loop","seo-aeo"]
priority: null
start_date: null
target_date: null
iteration: null
title: "リリース・デプロイとclose-out"
owners: ["daishiman"]
created_at: "2026-09-04T05:19:32Z"
updated_at: "2026-09-04T05:19:32Z"
status: "active"
depends_on: ["SYS-SEO-AEO-MEASUREMENT-LOOP-P12"]
related_nodes: ["arch-system-spec-overview","arch-two-layer-platform"]
resource_scope: ["docs/spec/feat-seo-aeo-measurement-loop/release-deploy.md"]
purpose: "Cron Trigger・自動反映エンジン・停止検出のリリース手順を確定し、close-out証跡を記録する。"
goal: "Cron Trigger・自動反映エンジン・停止検出のリリース手順を確定し、close-out証跡を記録する。"
scope_in: ["Produced artifacts: docs/spec/feat-seo-aeo-measurement-loop/release-deploy.md","Consumed artifacts: features/feat-seo-aeo-measurement-loop.md, features/feat-seo-aeo-measurement-loop.context.json, system-spec/backend.md, system-spec/maintenance-ops.md, system-spec/database.md, SYS-SEO-AEO-MEASUREMENT-LOOP-P12","Write scope/touches: docs/spec/feat-seo-aeo-measurement-loop/release-deploy.md"]
...
acceptance: ["Automated commands: `python3 \"/Users/dm/dev/dev/個人開発/harness/marketplaces/local/plugins/system-dev-planner/scripts/validate-system-plan.py\" --repo-root . --staging .dev-graph/staging/feature-package-feat-seo-aeo-measurement-loop`","Automated commands: `pnpm typecheck`","Required evidence:"]
...
phase_ref: "P13"
file_path: "tasks/feat-seo-aeo-measurement-loop/sys-seo-aeo-measurement-loop-p13.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T05:19:32Z","origin_kind":"system-dev-planner","source_digest":"46209e547af534e49404d69ee60347cc4e61a4351d2310c497f51b36ee745eda","source_path":".dev-graph/published/feature-package-feat-seo-aeo-measurement-loop/task-specs/phase-13-release-deploy.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-seo-aeo-measurement-loopのP13 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-seo-aeo-measurement-loop/sys-seo-aeo-measurement-loop-p13.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-mav8","github_mirror":null,"linked_at":"2026-09-04T07:34:40Z","sync_state":"linked"}
...
# System task overlay: リリース・デプロイとclose-out
...
- parent_feature: feat-seo-aeo-measurement-loop
- phase_ref: P13
- classification: confidence=1.0; reason=feat-seo-aeo-measurement-loopのP13 lifecycle責務への確定写像; candidate=tasks/feat-seo-aeo-measurement-loop/sys-seo-aeo-measurement-loop-p13.md
...
Cron Trigger・自動反映エンジン・停止検出のリリース手順を確定し、close-out証跡を記録する。

## 背景

実装・検証・文書化が揃った状態をリリースへ運び、close-out証跡を残す。

## 前提条件

- Required spec/architecture/phase/task nodes: feat-seo-aeo-measurement-loop, arch-system-spec-overview, arch-two-layer-platform, SYS-SEO-AEO-MEASUREMENT-LOOP-P12
...
- Frontend: N/A: reason=画面変更は発生せずリリース手順の確定のみ行う
- Backend: N/A: reason=実装変更はP05で完了済み
- API: N/A: reason=API契約の変更を行わない
- Data: N/A: reason=データモデルの変更を行わない
- Infrastructure: applicable; IaC/deploy=Cron Trigger・自動反映エンジン・停止検出のリリース手順を確定する
- Security: applicable; control=資格情報未登録でも系統①自動反映が成立することをリリース前提として確認する
- Quality: applicable; tests/gates=リリース前にVerification and evidenceの全コマンドが再実行され通ることを確認する
- Documentation: applicable; docs=docs/spec/feat-seo-aeo-measurement-loop/release-deploy.md を作成する
- Operations: applicable; runbook/monitoring=停止トグルが運営画面から機能することをリリース後に確認する
...
- Produced artifacts: docs/spec/feat-seo-aeo-measurement-loop/release-deploy.md
- Consumed artifacts: features/feat-seo-aeo-measurement-loop.md, features/feat-seo-aeo-measurement-loop.context.json, system-spec/backend.md, system-spec/maintenance-ops.md, system-spec/database.md, SYS-SEO-AEO-MEASUREMENT-LOOP-P12
- Write scope/touches: docs/spec/feat-seo-aeo-measurement-loop/release-deploy.md
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-SEO-AEO-MEASUREMENT-LOOP-P13を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-SEO-AEO-MEASUREMENT-LOOP-P13として割り当てる
- Worktree lease: 実装開始前にSYS-SEO-AEO-MEASUREMENT-LOOP-P13をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence:
  - docs/spec/feat-seo-aeo-measurement-loop/release-deploy.md
- Acceptance state: P13: Cron Trigger・自動反映エンジン・停止検出をリリース計画へ反映し、リリース後に停止トグルが運営画面から機能すること、およびspec/architecture writebackをclose-out証跡として記録する。
...
- P13 spec/architecture writeback: features/feat-seo-aeo-measurement-loop.md の implementation_readiness と system-spec/backend.md / maintenance-ops.md の対応セルへ、exact-13完了とA1-A8充足を書き戻す

## Rollout and rollback

- Rollout: SYS-SEO-AEO-MEASUREMENT-LOOP-P13の成果物をwrite_scope内へ適用し、検証PASS後に依存する次phaseへ渡す
...
- Completion condition: P13: Cron Trigger・自動反映エンジン・停止検出をリリース計画へ反映し、リリース後に停止トグルが運営画面から機能すること、およびspec/architecture writebackをclose-out証跡として記録する。
...
- Phase doc: references/system-plan-phase-names.md#P13
- Dependencies: SYS-SEO-AEO-MEASUREMENT-LOOP-P12
