...
purpose: "P02設計をNFR1-9全項目と照合する独立レビューを行い、可逆性・対象範囲・根拠系統限定・秘密情報境界に単一障害点が無いことを確認する。"
goal: "P02設計をNFR1-9全項目と照合する独立レビューを行い、可逆性・対象範囲・根拠系統限定・秘密情報境界に単一障害点が無いことを確認する。"
...
P02設計をNFR1-9全項目と照合する独立レビューを行い、可逆性・対象範囲・根拠系統限定・秘密情報境界に単一障害点が無いことを確認する。
...
- Acceptance state: P03: P02設計をNFR1〜NFR9全項目と照合する独立レビューを実施し、指摘があればP02を更新し、可逆性・対象範囲・根拠系統限定・秘密情報境界の4点に単一障害点がないことをレビュー記録として残す。
...
- Completion condition: P03: P02設計をNFR1〜NFR9全項目と照合する独立レビューを実施し、指摘があればP02を更新し、可逆性・対象範囲・根拠系統限定・秘密情報境界の4点に単一障害点がないことをレビュー記録として残す。
