---
graph_node_id: "SYS-REFERENCE-BLOG-ADMIN-UX-P11"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-reference-blog-admin-ux"
domain: "documentation"
tags: ["p11","feat-reference-blog-admin-ux"]
priority: null
start_date: null
target_date: null
iteration: null
title: "全URL分析・受入・QA証跡の再現可能な集約"
owners: ["daishiman"]
created_at: "2026-08-29T14:56:20Z"
updated_at: "2026-09-08T08:18:12.017897Z"
status: "active"
depends_on: ["SYS-REFERENCE-BLOG-ADMIN-UX-P07","SYS-REFERENCE-BLOG-ADMIN-UX-P09","SYS-REFERENCE-BLOG-ADMIN-UX-P10"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-reference-blog-admin-ux/evidence/"]
purpose: "URL inventory、representative capture、画面ID、A1–A12、test/QA/usability verdictを一つのindexとmanifestへ集約し、第三者が再現できる状態にする。"
goal: "URL inventory、representative capture、画面ID、A1–A12、test/QA/usability verdictを一つのindexとmanifestへ集約し、第三者が再現できる状態にする。"
scope_in: ["Produced artifacts: evidence bundle、index、manifest、reproduction receipt","Consumed artifacts: features/feat-reference-blog-admin-ux.md, features/feat-reference-blog-admin-ux.context.json, system-spec/ui-ux.md, system-spec/frontend.md, SYS-REFERENCE-BLOG-ADMIN-UX-P07, SYS-REFERENCE-BLOG-ADMIN-UX-P09, SYS-REFERENCE-BLOG-ADMIN-UX-P10","Write scope/touches: docs/spec/feat-reference-blog-admin-ux/evidence/"]
...
acceptance: ["Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-reference-blog-admin-ux`","Automated commands: `pnpm typecheck`、`pnpm content:validate`、対象test suite。実装を持たないphaseは適用外理由をreportへ残す","Required evidence: docs/spec/feat-reference-blog-admin-ux/evidence/","Acceptance state: P11: evidence/index.jsonが全URL台帳snapshot、画面型代表証跡、A1–A12、P06/P07/P09/P10をpath・digest・取得日時・tool versionで参照し、missing/duplicate/stale 0、写真・本文の再配布0、再実行commandがexit0になる。"]
architecture_refs: ["arch-system-spec-overview","arch-two-layer-platform"]
parent_feature: "feat-reference-blog-admin-ux"
feature_package_id: "feature-package/feat-reference-blog-admin-ux"
phase_ref: "P11"
file_path: "tasks/feat-reference-blog-admin-ux/sys-reference-blog-admin-ux-p11.md"
template_id: "task"
...
classification_reason: "feat-reference-blog-admin-ux の P11 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reference-blog-admin-ux/sys-reference-blog-admin-ux-p11.md","confidence":1}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-z8x6.11","github_mirror":null,"linked_at":"2026-09-08T08:14:07Z","sync_state":"linked"}
...
# System task overlay: 全URL分析・受入・QA証跡の再現可能な集約
...
- parent_feature: feat-reference-blog-admin-ux
- phase_ref: P11
- classification: confidence=1.0; reason=feat-reference-blog-admin-uxのP11 lifecycle責務への確定写像; candidate=tasks/feat-reference-blog-admin-ux/sys-reference-blog-admin-ux-p11.md
...
URL inventory、representative capture、画面ID、A1–A12、test/QA/usability verdictを一つのindexとmanifestへ集約し、第三者が再現できる状態にする。

## 背景

参照ブログの14サブサイトマップと公開URL 1,072件のベースライン、画面型別の共通構成、現行管理画面の実装済み機能とgapを、features/feat-reference-blog-admin-ux.mdのA1–A12へtraceする。情報階層と操作原則だけを抽象化し、第三者の文章・写真・ロゴ・固有名・色値を転用しない。本phaseはSYS-REFERENCE-BLOG-ADMIN-UX-P07、SYS-REFERENCE-BLOG-ADMIN-UX-P09、SYS-REFERENCE-BLOG-ADMIN-UX-P10の確定成果物を入力にする。

## 前提条件

- Required spec/architecture/phase/task nodes: feat-reference-blog-admin-ux, spec-system-spec-index, arch-system-spec-overview, SYS-REFERENCE-BLOG-ADMIN-UX-P07, SYS-REFERENCE-BLOG-ADMIN-UX-P09, SYS-REFERENCE-BLOG-ADMIN-UX-P10
...
- Frontend: N/A: UI変更なし
- Backend: N/A: service変更なし
- API: N/A: API変更なし
- Data: applicable; evidence manifestを機械可読にする
- Infrastructure: N/A: 配備変更なし
- Security: applicable; 証跡に秘匿情報・第三者素材を含めない
- Quality: applicable; digest/stalenessを検査する
- Documentation: applicable; 再現可能な証跡を集約する
- Operations: applicable; rerun手順を固定する
...
- Produced artifacts: evidence bundle、index、manifest、reproduction receipt
- Consumed artifacts: features/feat-reference-blog-admin-ux.md, features/feat-reference-blog-admin-ux.context.json, system-spec/ui-ux.md, system-spec/frontend.md, SYS-REFERENCE-BLOG-ADMIN-UX-P07, SYS-REFERENCE-BLOG-ADMIN-UX-P09, SYS-REFERENCE-BLOG-ADMIN-UX-P10
- Write scope/touches: docs/spec/feat-reference-blog-admin-ux/evidence/
...
- PR body contract: Beads issue参照とdev-graph graph_node_id=SYS-REFERENCE-BLOG-ADMIN-UX-P11を記載し、target branchはdevとする
- Ownership boundary: system-dev-plannerはintentを宣言し、dev-graphが起票・依存・完了収束を所有する

## Branch and worktree execution

- Branch: dev-graph登録後にC15がdevgraph/SYS-REFERENCE-BLOG-ADMIN-UX-P11として割り当てる
- Worktree lease: 実装開始前にSYS-REFERENCE-BLOG-ADMIN-UX-P11をclaimし、heartbeatとreleaseをlease契約どおり行う
...
- Required evidence: docs/spec/feat-reference-blog-admin-ux/evidence/
- Acceptance state: P11: evidence/index.jsonが全URL台帳snapshot、画面型代表証跡、A1–A12、P06/P07/P09/P10をpath・digest・取得日時・tool versionで参照し、missing/duplicate/stale 0、写真・本文の再配布0、再実行commandがexit0になる。
...
- Rollout: evidence bundle、index、manifest、reproduction receiptをwrite_scope内へ適用し、検証PASS後に依存する次phaseへ渡す
...
- Completion condition: P11: evidence/index.jsonが全URL台帳snapshot、画面型代表証跡、A1–A12、P06/P07/P09/P10をpath・digest・取得日時・tool versionで参照し、missing/duplicate/stale 0、写真・本文の再配布0、再実行commandがexit0になる。
...
- Dependencies: SYS-REFERENCE-BLOG-ADMIN-UX-P07, SYS-REFERENCE-BLOG-ADMIN-UX-P09, SYS-REFERENCE-BLOG-ADMIN-UX-P10
