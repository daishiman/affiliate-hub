---
graph_node_id: "SYS-REFERENCE-BLOG-ADMIN-UX-P04"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "受入・回帰・アクセシビリティ・ユーザビリティのテスト設計"
owners: ["daishiman"]
created_at: "2026-08-29T14:56:20Z"
updated_at: "2026-09-08T08:15:01.961009Z"
status: "active"
depends_on: ["SYS-REFERENCE-BLOG-ADMIN-UX-P03"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-reference-blog-admin-ux/test-design.md","docs/spec/feat-reference-blog-admin-ux/usability-test-protocol.md","tests/fixtures/reference-blog-admin-ux/"]
purpose: "A1–A12、保存状態、URL preview、掲載先逆引き、非模倣、公開面responsiveを単体・contract・integration・E2E・a11y・security・performance・usabilityの実行可能なテストへ先に写像する。"
...
scope_in: ["Produced artifacts: test design、usability protocol、安全なfixture契約","Consumed artifacts: features/feat-reference-blog-admin-ux.md, features/feat-reference-blog-admin-ux.context.json, system-spec/ui-ux.md, system-spec/frontend.md, SYS-REFERENCE-BLOG-ADMIN-UX-P03","Write scope/touches: docs/spec/feat-reference-blog-admin-ux/test-design.md, docs/spec/feat-reference-blog-admin-ux/usability-test-protocol.md, tests/fixtures/reference-blog-admin-ux/"]
...
acceptance: ["Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-reference-blog-admin-ux`","Automated commands: `pnpm typecheck`、`pnpm content:validate`、対象test suite。実装を持たないphaseは適用外理由をreportへ残す","Required evidence: docs/spec/feat-reference-blog-admin-ux/test-design.md, docs/spec/feat-reference-blog-admin-ux/usability-test-protocol.md, tests/fixtures/reference-blog-admin-ux/","Acceptance state: P04: A1–A12ごとに正常・空・読込・失敗・権限・境界・mobileのケース、初見参加者のタスク成功率90%以上の測定法、axe重大違反0、200% zoom、keyboard完結、SSRF negative fixture、画像無しfallback、重複URL、保存競合・復元のテストが一意IDで定義される。"]
architecture_refs: ["arch-system-spec-overview","arch-two-layer-platform"]
parent_feature: "feat-reference-blog-admin-ux"
feature_package_id: "feature-package/feat-reference-blog-admin-ux"
phase_ref: "P04"
file_path: "tasks/feat-reference-blog-admin-ux/sys-reference-blog-admin-ux-p04.md"
template_id: "task"
...
classification_reason: "feat-reference-blog-admin-ux の P04 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reference-blog-admin-ux/sys-reference-blog-admin-ux-p04.md","confidence":1}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-z8x6.4","github_mirror":null,"linked_at":"2026-09-08T08:14:07Z","sync_state":"linked"}
