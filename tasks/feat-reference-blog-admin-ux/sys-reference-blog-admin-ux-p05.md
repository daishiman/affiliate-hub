---
graph_node_id: "SYS-REFERENCE-BLOG-ADMIN-UX-P05"
artifact_kind: "task"
artifact_subtypes: []
...
scope_in: ["Produced artifacts: 分析script、public component、admin interaction、affiliate preview/placement read model、D1永続化、migration、tests","Consumed artifacts: features/feat-reference-blog-admin-ux.md, features/feat-reference-blog-admin-ux.context.json, system-spec/ui-ux.md, system-spec/frontend.md, SYS-REFERENCE-BLOG-ADMIN-UX-P04","Write scope/touches: scripts/reference-site-analysis/, src/app/admin/blog/, src/app/admin/content/, src/app/admin/affiliate/links/, src/app/s/[site]/, src/presentation/admin/, src/presentation/site/, src/presentation/ui/, src/domain/blogops/, src/domain/monetization/, src/application/usecases/blog-ops/, src/application/usecases/monetization/, src/application/read-models/, src/application/ports/, src/infrastructure/persistence/d1/, src/infrastructure/persistence/sample/, src/db/schema.ts, drizzle/, tests/"]
...
acceptance: ["Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-reference-blog-admin-ux`","Automated commands: `pnpm typecheck`、`pnpm content:validate`、対象test suite。実装を持たないphaseは適用外理由をreportへ残す","Required evidence: scripts/reference-site-analysis/, src/app/admin/blog/, src/app/admin/content/, src/app/admin/affiliate/links/, src/app/s/[site]/, src/presentation/admin/, src/presentation/site/, src/presentation/ui/, src/domain/blogops/, src/domain/monetization/, src/application/usecases/blog-ops/, src/application/usecases/monetization/, src/application/read-models/, src/application/ports/, src/infrastructure/persistence/d1/, src/infrastructure/persistence/sample/, src/db/schema.ts, drizzle/, tests/","Acceptance state: P05: 依存順に、分析snapshot/read model、独自tokenのheader/body/sidebar/footer・記事型、図解block、admin共通save state、記事new/edit/improvement、affiliate URL previewとerror/duplicate/fallback、affiliate ledgerとplacement reverse map、永続化・監査・権限を実装し、P04のテストをgreenにする。既存blog-ops/affiliate usecaseの重複実装は0件にする。"]
architecture_refs: ["arch-system-spec-overview","arch-two-layer-platform"]
parent_feature: "feat-reference-blog-admin-ux"
feature_package_id: "feature-package/feat-reference-blog-admin-ux"
phase_ref: "P05"
file_path: "tasks/feat-reference-blog-admin-ux/sys-reference-blog-admin-ux-p05.md"
template_id: "task"
...
classification_reason: "feat-reference-blog-admin-ux の P05 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-reference-blog-admin-ux/sys-reference-blog-admin-ux-p05.md","confidence":1}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-z8x6.5","github_mirror":null,"linked_at":"2026-09-08T08:14:07Z","sync_state":"linked"}
