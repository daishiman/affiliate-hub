...
artifact_kind: "task"
artifact_subtypes: []
beads_linkage: "ah-z98"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-uiux-overhaul/sys-uiux-overhaul-p06.md","confidence":1.0}]
classification_confidence: 1.0
classification_reason: "feat-uiux-overhaul の P06 lifecycle 責務への確定写像"
...
file_path: "tasks/feat-uiux-overhaul/sys-uiux-overhaul-p06.md"
github_project_linkages: []
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
graph_node_id: "SYS-UIUX-OVERHAUL-P06"
...
related_nodes: []
resource_scope: ["docs/spec/feat-uiux-overhaul/test-run-report.md"]
source_lineage: {"imported_at":"2026-08-21T12:39:22Z","origin_kind":"system-dev-planner","source_digest":"3c9e340b6675b9d0b51c5a8b14331885611cb6e7f9129f16eb853231a3a7fbf0","source_path":".dev-graph/published/feature-package-feat-uiux-overhaul/task-specs/phase-06-test-run.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
start_date: null
status: "active"
...
purpose: "P04 で設計し P05 で緑化させたテストを全量実行し、既存テストの回帰0件とカバレッジ目標達成を確認した状態を成立させる。"
goal: "P04 で設計し P05 で緑化させたテストを全量実行し、既存テストの回帰0件とカバレッジ目標達成を確認した状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-uiux-overhaul/test-run-report.md (全量実行結果・カバレッジ・回帰有無)","Consumed artifacts: src/presentation/ui/__tests__/, src/app/api/admin/__tests__/","Write scope/touches: docs/spec/feat-uiux-overhaul/test-run-report.md"]
...
acceptance: ["Automated commands: `pnpm run preview` (Workers ランタイム, localhost:8787) 上で P06 に対応する検証コマンドを実行する","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-uiux-overhaul` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P06 の 成果物 section に記載した produced artifacts のパス"]
...
- source spec: `.dev-graph/published/feature-package-feat-uiux-overhaul/task-specs/phase-06-test-run.md` (昇格済み generation 本文を byte-for-byte 引用)
