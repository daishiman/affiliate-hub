...
artifact_kind: "task"
artifact_subtypes: []
beads_linkage: "ah-cnn"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-uiux-overhaul/sys-uiux-overhaul-p04.md","confidence":1.0}]
classification_confidence: 1.0
classification_reason: "feat-uiux-overhaul の P04 lifecycle 責務への確定写像"
...
depends_on: ["SYS-UIUX-OVERHAUL-P03"]
domain: "quality"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-uiux-overhaul"
file_path: "tasks/feat-uiux-overhaul/sys-uiux-overhaul-p04.md"
github_project_linkages: []
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
graph_node_id: "SYS-UIUX-OVERHAUL-P04"
...
related_nodes: []
resource_scope: ["docs/spec/feat-uiux-overhaul/test-design.md","src/presentation/ui/__tests__/","src/app/api/admin/__tests__/"]
source_lineage: {"imported_at":"2026-08-21T12:39:22Z","origin_kind":"system-dev-planner","source_digest":"3c9e340b6675b9d0b51c5a8b14331885611cb6e7f9129f16eb853231a3a7fbf0","source_path":".dev-graph/published/feature-package-feat-uiux-overhaul/task-specs/phase-04-test-design.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
start_date: null
status: "active"
...
purpose: "受入10件それぞれを検証するテストを、実装着手前に振る舞いベースで設計し、失敗する状態のテストケースとして配置した状態を成立させる。"
goal: "受入10件それぞれを検証するテストを、実装着手前に振る舞いベースで設計し、失敗する状態のテストケースとして配置した状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-uiux-overhaul/test-design.md (受入10件とテストの対応表), src/presentation/ui/__tests__/ (サイドバー開閉・アイコン識別・カード密度・情報削減の振る舞いテスト), src/app/api/admin/__tests__/ (管理対象4種の一覧/作成/更新/削除と投稿状態参照のAPI契約テスト)","Consumed artifacts: docs/spec/feat-uiux-overhaul/design-review.md, docs/spec/feat-uiux-overhaul/component-contract.md, docs/spec/feat-uiux-overhaul/admin-api-contract.md","Write scope/touches: docs/spec/feat-uiux-overhaul/test-design.md, src/presentation/ui/__tests__/, src/app/api/admin/__tests__/"]
...
acceptance: ["Automated commands: `pnpm run preview` (Workers ランタイム, localhost:8787) 上で P04 に対応する検証コマンドを実行する","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-uiux-overhaul` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P04 の 成果物 section に記載した produced artifacts のパス"]
...
- source spec: `.dev-graph/published/feature-package-feat-uiux-overhaul/task-specs/phase-04-test-design.md` (昇格済み generation 本文を byte-for-byte 引用)
