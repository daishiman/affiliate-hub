...
artifact_kind: "task"
artifact_subtypes: []
beads_linkage: "ah-jah"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-uiux-overhaul/sys-uiux-overhaul-p02.md","confidence":1.0}]
classification_confidence: 1.0
classification_reason: "feat-uiux-overhaul の P02 lifecycle 責務への確定写像"
...
depends_on: ["SYS-UIUX-OVERHAUL-P01"]
domain: "documentation"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-uiux-overhaul"
file_path: "tasks/feat-uiux-overhaul/sys-uiux-overhaul-p02.md"
github_project_linkages: []
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
graph_node_id: "SYS-UIUX-OVERHAUL-P02"
...
related_nodes: []
resource_scope: ["docs/spec/feat-uiux-overhaul/screen-architecture.md","docs/spec/feat-uiux-overhaul/component-contract.md","docs/spec/feat-uiux-overhaul/sns-provider-contract.md","docs/spec/feat-uiux-overhaul/blog-scaffold-contract.md","docs/spec/feat-uiux-overhaul/admin-api-contract.md"]
source_lineage: {"imported_at":"2026-08-21T12:39:22Z","origin_kind":"system-dev-planner","source_digest":"3c9e340b6675b9d0b51c5a8b14331885611cb6e7f9129f16eb853231a3a7fbf0","source_path":".dev-graph/published/feature-package-feat-uiux-overhaul/task-specs/phase-02-architecture.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
start_date: null
status: "active"
...
title: "単一用途画面・共通コンポーネント・マルチSNS抽象の設計"
tracker_binding: "beads"
updated_at: "2026-08-21T12:39:22Z"
purpose: "P01 の要求ベースラインを、単一用途画面の遷移設計、共通コンポーネント階層と重複排除規約、アイコン付き開閉サイドバーの構造、SNSプロバイダ抽象、ブログ別コンポーネント scaffold 契約、管理API契約の6設計文書へ落とし込んだ状態を成立させる。"
...
scope_in: ["Produced artifacts: docs/spec/feat-uiux-overhaul/screen-architecture.md (単一用途画面への分割と遷移設計), docs/spec/feat-uiux-overhaul/component-contract.md (primitives/patterns/templates 階層と共通部品の責務境界・重複禁止規約・カード間隔と文章量のトークン規則), docs/spec/feat-uiux-overhaul/sns-provider-contract.md (X/Facebook 等を追加実装のみで拡張できるプロバイダ抽象), docs/spec/feat-uiux-overhaul/blog-scaffold-contract.md (新規ブログ構築時のブログ固有コンポーネント一式の scaffold 仕様), docs/spec/feat-uiux-overhaul/admin-api-contract.md (管理対象4種の一覧/作成/更新/削除と投稿状態参照のAPI契約))","Consumed artifacts: docs/spec/feat-uiux-overhaul/requirements-baseline.md, docs/spec/feat-uiux-overhaul/screen-inventory.md, docs/spec/feat-uiux-overhaul/information-priority-map.json","Write scope/touches: docs/spec/feat-uiux-overhaul/screen-architecture.md, docs/spec/feat-uiux-overhaul/component-contract.md, docs/spec/feat-uiux-overhaul/sns-provider-contract.md, docs/spec/feat-uiux-overhaul/blog-scaffold-contract.md, docs/spec/feat-uiux-overhaul/admin-api-contract.md"]
...
acceptance: ["Automated commands: `pnpm run preview` (Workers ランタイム, localhost:8787) 上で P02 に対応する検証コマンドを実行する","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-uiux-overhaul` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P02 の 成果物 section に記載した produced artifacts のパス"]
...
- source spec: `.dev-graph/published/feature-package-feat-uiux-overhaul/task-specs/phase-02-architecture.md` (昇格済み generation 本文を byte-for-byte 引用)
