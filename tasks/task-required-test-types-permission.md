---
graph_node_id: "task-required-test-types-permission"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "必須テスト種別を宣言する（権限・テナント・セキュリティ 24 件）"
owners: ["daishiman"]
created_at: "2026-08-17T22:00:00Z"
updated_at: "2026-09-08T07:18:08.638787Z"
status: "draft"
...
purpose: null
goal: null
mvp_alignment: {"background":"240 要件のうち必須テスト種別を宣言できているのは 12 件だけで、権限・テナント・セキュリティの 24 件は未宣言のまま","mvp_fit":"enabling","purpose":"権限・テナント・セキュリティの 24 件について、必要なテスト種別を 1 件ずつ決める","rationale":"種別を決めないとテストは書きやすいところから書かれ、権限のできてはいけない側・禁止された状態遷移・障害注入が永久に残る"}
scope_in: []
scope_out: []
acceptance: []
architecture_refs: []
...
phase_ref: null
file_path: "tasks/task-required-test-types-permission.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/task-required-test-types-permission.md","confidence":0.95}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-99p","github_mirror":null,"linked_at":"2026-09-08T07:14:07Z","sync_state":"linked"}
...
そこで**文脈ごと**に分けた。この課題はそのうちの 1 つで、24 件だけを見ればよい。
...
対象の要件 24 件（**権限・テナント・セキュリティ**）:

`REQ-P05` `REQ-P06` `REQ-P07` `REQ-P09` `REQ-R01` `REQ-R02` `REQ-R03` `REQ-R04` `REQ-R05` `REQ-R06` `REQ-R07` `REQ-R08` `REQ-R09` `REQ-R10` `REQ-SEC01` `REQ-SEC02` `REQ-SEC03` `REQ-SEC04` `REQ-SEC05` `REQ-SEC06` `REQ-SEC07` `REQ-SEC08` `REQ-SEC09` `REQ-SEC10`
...
1. 対象 24 件を 1 件ずつ**中身を読んで**、性質を決める
...
- 対象 24 件すべてに、宣言か理由つき除外がある
- `node scripts/required-test-types.mjs` が緑
- `TEST_TYPES_MAX_UNDECLARED` が 24 件ぶん下がっている
