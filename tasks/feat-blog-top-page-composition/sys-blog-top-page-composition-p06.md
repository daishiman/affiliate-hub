---
graph_node_id: "SYS-BLOG-TOP-PAGE-COMPOSITION-P06"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "単体・結合・境界値・回帰・a11y・no-jsテストの実行"
owners: ["daishiman"]
created_at: "2026-09-06T00:30:33Z"
updated_at: "2026-09-06T00:38:30.286806Z"
status: "active"
depends_on: ["SYS-BLOG-TOP-PAGE-COMPOSITION-P05"]
related_nodes: ["spec-system-spec-index","arch-system-spec-overview"]
resource_scope: ["docs/spec/feat-blog-top-page-composition/test-run-report.md"]
purpose: "P05の実装に対してP04が用意した単体・結合・境界値・回帰テスト、axe-coreによるアクセシビリティスキャン、JavaScript無効時のe2e、非模倣静的検査を実行し、結果をreportへ残す。"
goal: "P05の実装に対してP04が用意した単体・結合・境界値・回帰テスト、axe-coreによるアクセシビリティスキャン、JavaScript無効時のe2e、非模倣静的検査を実行し、結果をreportへ残す。"
scope_in: ["Produced artifacts: test-run report(単体/結合/境界値/回帰/axe-core/no-js e2e/非模倣静的検査の実行結果とcoverage)","Consumed artifacts: src/app/s/[site]/page.tsx, src/presentation/site/home-content.tsx, src/presentation/site/blog-top-bands.tsx, tests/blog-top-page/*","Write scope/touches: docs/spec/feat-blog-top-page-composition/test-run-report.md"]
...
acceptance: ["Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-blog-top-page-composition`","Automated commands: `pnpm typecheck`、`pnpm lint`、`pnpm test`、対象test suite(playwright e2eを含む)。実装を持たないphaseは適用外理由をreportへ残す","Required evidence: docs/spec/feat-blog-top-page-composition/test-run-report.md"]
...
phase_ref: "P06"
file_path: "tasks/feat-blog-top-page-composition/sys-blog-top-page-composition-p06.md"
template_id: "task"
...
classification_reason: "feat-blog-top-page-compositionのP06 lifecycle責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-blog-top-page-composition/sys-blog-top-page-composition-p06.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-u7dp","github_mirror":null,"linked_at":"2026-09-04T07:34:54Z","sync_state":"linked"}
