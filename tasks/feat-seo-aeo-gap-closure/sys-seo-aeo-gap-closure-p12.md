---
graph_node_id: "SYS-SEO-AEO-GAP-CLOSURE-P12"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-seo-aeo-gap-closure"
domain: "documentation"
tags: ["p12","feat-seo-aeo-gap-closure"]
priority: null
start_date: null
target_date: null
iteration: null
...
purpose: "定期再点検が落ちたときに誰が何を見て何をするかを運用手順として書き、点検履歴と管理画面一覧の読み方を運用者向けに文書化する。"
goal: "定期再点検が落ちたときに誰が何を見て何をするかを運用手順として書き、点検履歴と管理画面一覧の読み方を運用者向けに文書化する。"
scope_in: ["Produced artifacts: docs/spec/feat-seo-aeo-gap-closure/operations.md (定期再点検の監視・失敗時対応・履歴の読み方); docs/spec/feat-seo-aeo-gap-closure/documentation.md (実装した導出規則と保持方針の参照先まとめ)","Consumed artifacts: docs/spec/feat-seo-aeo-gap-closure/final-review.md, docs/spec/feat-seo-aeo-gap-closure/evidence.md, docs/spec/feat-seo-aeo-gap-closure/retention-policy.md","Write scope/touches: docs/spec/feat-seo-aeo-gap-closure/operations.md, docs/spec/feat-seo-aeo-gap-closure/documentation.md"]
...
acceptance: ["Automated commands: `pnpm run lint` (文書が参照する実装パスの実在を確認する)","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-seo-aeo-gap-closure` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P12 の 成果物 section に記載した produced artifacts のパス"]
architecture_refs: ["arch-system-spec-overview","arch-two-layer-platform"]
parent_feature: "feat-seo-aeo-gap-closure"
feature_package_id: "feature-package/feat-seo-aeo-gap-closure"
phase_ref: "P12"
file_path: "tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p12.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T02:37:00Z","origin_kind":"system-dev-planner","source_digest":"2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298","source_path":".dev-graph/published/generations/feature-package-feat-seo-aeo-gap-closure/2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298/task-specs/phase-12-documentation-operations.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-seo-aeo-gap-closure の P12 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p12.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-f60p.12","github_mirror":null,"linked_at":"2026-09-04T04:00:00Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T08:38:19Z","evidence_refs":["beads:ah-f60p.12"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
...
- parent_feature: feat-seo-aeo-gap-closure
- phase_ref: P12
- classification: confidence=1.0; reason=feat-seo-aeo-gap-closure の P12 lifecycle 責務への確定写像; candidate=tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p12.md
...
定期再点検が落ちたときに誰が何を見て何をするかを運用手順として書き、点検履歴と管理画面一覧の読み方を運用者向けに文書化する。

## 背景

定期再点検は人が起動しないので、落ちたことに気づく経路が管理画面一覧しかない。その一覧を誰がいつ見るのかが決まっていないと、仕組みだけあって使われない状態になる。
...
- Quality: applicable; 手順どおりに辿れることを確認する
- Documentation: applicable; 運用文書が本 phase の成果物である
- Operations: applicable; 定期再点検の失敗時の対応手順を確定する
...
- Produced artifacts: docs/spec/feat-seo-aeo-gap-closure/operations.md (定期再点検の監視・失敗時対応・履歴の読み方); docs/spec/feat-seo-aeo-gap-closure/documentation.md (実装した導出規則と保持方針の参照先まとめ)
- Consumed artifacts: docs/spec/feat-seo-aeo-gap-closure/final-review.md, docs/spec/feat-seo-aeo-gap-closure/evidence.md, docs/spec/feat-seo-aeo-gap-closure/retention-policy.md
- Write scope/touches: docs/spec/feat-seo-aeo-gap-closure/operations.md, docs/spec/feat-seo-aeo-gap-closure/documentation.md
...
- PR body contract: Closes #issue (beads issue) + dev-graph graph_node_id=SYS-SEO-AEO-GAP-CLOSURE-P12; PR の宛先は dev ブランチとする
- Ownership boundary: system-dev-plannerはintentのみを宣言し、dev-graphがtracker mutationとreconciliationを行う

## Branch and worktree execution

- Branch: assigned after dev-graph registration by C15 as devgraph/SYS-SEO-AEO-GAP-CLOSURE-P12; system-dev-plannerは事前割当を行わない
- Worktree lease: claim SYS-SEO-AEO-GAP-CLOSURE-P12 before implementation; heartbeat/release は dev-graph worktree lease 契約に従う
...
- 層別方針: 運用手順書の記載内容が実際の操作と一致することを、手順どおりの実行で確認する。本 phase は新規のテスト層を持たない。
- 保守性制約: pixel位置依存・DOM構造依存のテストを禁止し、可視ラベル・アクセシブル名・返却データの属性など振る舞い検証に限定する。

## Verification and evidence

- Automated commands: `pnpm run lint` (文書が参照する実装パスの実在を確認する)
...
- Goal: 定期再点検が落ちたときに誰が何を見て何をするかを運用手順として書き、点検履歴と管理画面一覧の読み方を運用者向けに文書化する。
- Generic execution prompt: feat-seo-aeo-gap-closure の goal (手順記事と読み上げ向けの構造化データが記事から導出され、公開時点検の結果が履歴として残り、公開後の記事も定期に再点検されて陳腐化に気づける状態になっている) と本 task の 前提条件/成果物/write_scope/スコープ外 を渡し、実装手段は固定せず P12 の目的を満たす成果物を作らせる
...
- Dependencies: SYS-SEO-AEO-GAP-CLOSURE-P10, SYS-SEO-AEO-GAP-CLOSURE-P11
