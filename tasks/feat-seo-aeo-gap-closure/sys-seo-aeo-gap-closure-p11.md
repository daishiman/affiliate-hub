---
graph_node_id: "SYS-SEO-AEO-GAP-CLOSURE-P11"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-seo-aeo-gap-closure"
domain: "documentation"
tags: ["p11","feat-seo-aeo-gap-closure"]
priority: null
start_date: null
target_date: null
iteration: null
...
purpose: "P07 の受入判定と P09 の非機能検査の証跡を 1 箇所に集約し、後から第三者が同じ手順で再現できる形にする。"
goal: "P07 の受入判定と P09 の非機能検査の証跡を 1 箇所に集約し、後から第三者が同じ手順で再現できる形にする。"
scope_in: ["Produced artifacts: docs/spec/feat-seo-aeo-gap-closure/evidence.md (受入・品質の証跡一覧と再現手順)","Consumed artifacts: docs/spec/feat-seo-aeo-gap-closure/acceptance.md, docs/spec/feat-seo-aeo-gap-closure/quality-assurance.md, docs/spec/feat-seo-aeo-gap-closure/test-run.md","Write scope/touches: docs/spec/feat-seo-aeo-gap-closure/evidence.md"]
...
acceptance: ["Automated commands: `pnpm vitest run --reporter=dot` (証跡の再現手順どおりに実行できることを確かめる)","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-seo-aeo-gap-closure` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P11 の 成果物 section に記載した produced artifacts のパス"]
architecture_refs: ["arch-system-spec-overview","arch-two-layer-platform"]
parent_feature: "feat-seo-aeo-gap-closure"
feature_package_id: "feature-package/feat-seo-aeo-gap-closure"
phase_ref: "P11"
file_path: "tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p11.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T02:37:00Z","origin_kind":"system-dev-planner","source_digest":"2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298","source_path":".dev-graph/published/generations/feature-package-feat-seo-aeo-gap-closure/2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298/task-specs/phase-11-evidence.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-seo-aeo-gap-closure の P11 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p11.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-f60p.11","github_mirror":null,"linked_at":"2026-09-04T04:00:00Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T08:28:11Z","evidence_refs":["beads:ah-f60p.11"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
...
- parent_feature: feat-seo-aeo-gap-closure
- phase_ref: P11
- classification: confidence=1.0; reason=feat-seo-aeo-gap-closure の P11 lifecycle 責務への確定写像; candidate=tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p11.md
...
P07 の受入判定と P09 の非機能検査の証跡を 1 箇所に集約し、後から第三者が同じ手順で再現できる形にする。

## 背景

証跡が各 phase の文書に散っていると、リリース後に「なぜ良いと判断したのか」を辿るのに13 本を読み直すことになる。集約はそのための投資である。
...
- Quality: applicable; 証跡の再現可能性を確認する
- Documentation: applicable; 証跡集約が本 phase の成果物である
...
- Produced artifacts: docs/spec/feat-seo-aeo-gap-closure/evidence.md (受入・品質の証跡一覧と再現手順)
- Consumed artifacts: docs/spec/feat-seo-aeo-gap-closure/acceptance.md, docs/spec/feat-seo-aeo-gap-closure/quality-assurance.md, docs/spec/feat-seo-aeo-gap-closure/test-run.md
- Write scope/touches: docs/spec/feat-seo-aeo-gap-closure/evidence.md
...
- PR body contract: Closes #issue (beads issue) + dev-graph graph_node_id=SYS-SEO-AEO-GAP-CLOSURE-P11; PR の宛先は dev ブランチとする
- Ownership boundary: system-dev-plannerはintentのみを宣言し、dev-graphがtracker mutationとreconciliationを行う

## Branch and worktree execution

- Branch: assigned after dev-graph registration by C15 as devgraph/SYS-SEO-AEO-GAP-CLOSURE-P11; system-dev-plannerは事前割当を行わない
- Worktree lease: claim SYS-SEO-AEO-GAP-CLOSURE-P11 before implementation; heartbeat/release は dev-graph worktree lease 契約に従う
...
- 層別方針: 受入 6 件それぞれについて、判定に用いたコマンド出力と成果物パスを証跡として集約する。本 phase は新規のテスト層を持たない。
- 保守性制約: pixel位置依存・DOM構造依存のテストを禁止し、可視ラベル・アクセシブル名・返却データの属性など振る舞い検証に限定する。

## Verification and evidence

- Automated commands: `pnpm vitest run --reporter=dot` (証跡の再現手順どおりに実行できることを確かめる)
...
- Goal: P07 の受入判定と P09 の非機能検査の証跡を 1 箇所に集約し、後から第三者が同じ手順で再現できる形にする。
- Generic execution prompt: feat-seo-aeo-gap-closure の goal (手順記事と読み上げ向けの構造化データが記事から導出され、公開時点検の結果が履歴として残り、公開後の記事も定期に再点検されて陳腐化に気づける状態になっている) と本 task の 前提条件/成果物/write_scope/スコープ外 を渡し、実装手段は固定せず P11 の目的を満たす成果物を作らせる
...
- Dependencies: SYS-SEO-AEO-GAP-CLOSURE-P07, SYS-SEO-AEO-GAP-CLOSURE-P09
