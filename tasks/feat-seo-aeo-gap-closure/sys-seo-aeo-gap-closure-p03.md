---
graph_node_id: "SYS-SEO-AEO-GAP-CLOSURE-P03"
artifact_kind: "task"
artifact_subtypes: []
...
purpose: "P02 の設計が P01 の要求を漏れなく満たし、かつ scope_out に挙げた既存実装 (JSON-LD 導出本体・llms.txt・IndexNow・出典レジストリ・公開時点検の判定ロジック) を作り直していないことを、実装着手前に独立の目で確かめる。"
...
scope_in: ["Produced artifacts: docs/spec/feat-seo-aeo-gap-closure/design-review.md (指摘・是正・重複有無の判定と根拠)","Consumed artifacts: docs/spec/feat-seo-aeo-gap-closure/architecture.md, docs/spec/feat-seo-aeo-gap-closure/data-model.md, docs/spec/feat-seo-aeo-gap-closure/api-contract.md, docs/spec/feat-seo-aeo-gap-closure/requirements-baseline.md","Write scope/touches: docs/spec/feat-seo-aeo-gap-closure/design-review.md"]
...
acceptance: ["Automated commands: `pnpm run lint` (設計レビューで参照する既存実装の同定に破れが無いことを確認する)","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-seo-aeo-gap-closure` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P03 の 成果物 section に記載した produced artifacts のパス"]
architecture_refs: ["arch-system-spec-overview","arch-two-layer-platform"]
parent_feature: "feat-seo-aeo-gap-closure"
feature_package_id: "feature-package/feat-seo-aeo-gap-closure"
phase_ref: "P03"
file_path: "tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p03.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T02:37:00Z","origin_kind":"system-dev-planner","source_digest":"2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298","source_path":".dev-graph/published/generations/feature-package-feat-seo-aeo-gap-closure/2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298/task-specs/phase-03-design-review.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-seo-aeo-gap-closure の P03 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p03.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-f60p.3","github_mirror":null,"linked_at":"2026-09-04T04:00:00Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T04:41:38Z","evidence_refs":["beads:ah-f60p.3"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
...
- 層別方針: バックエンド: API 契約 と DB 結合の設計が既存 SEO 実装と重複しないことを独立に読み合わせる。
