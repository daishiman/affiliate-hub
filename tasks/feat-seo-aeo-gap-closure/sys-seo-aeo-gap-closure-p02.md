---
graph_node_id: "SYS-SEO-AEO-GAP-CLOSURE-P02"
artifact_kind: "task"
artifact_subtypes: []
...
purpose: "P01 で確定した要求を、点検履歴テーブルの列定義・drizzle マイグレーション番号・repository と port の境界・scheduled handler の設置点・publish-article への履歴追記の組込点・管理画面一覧の取得契約として設計へ落とす。"
...
scope_in: ["Produced artifacts: docs/spec/feat-seo-aeo-gap-closure/architecture.md (層境界・scheduled 入口・publish 経路への組込点); docs/spec/feat-seo-aeo-gap-closure/data-model.md (点検履歴テーブルの列定義と索引と保持窓の落とし方); docs/spec/feat-seo-aeo-gap-closure/api-contract.md (管理画面一覧の取得契約と返却形)","Consumed artifacts: docs/spec/feat-seo-aeo-gap-closure/requirements-baseline.md, docs/spec/feat-seo-aeo-gap-closure/derivation-rules.md, docs/spec/feat-seo-aeo-gap-closure/retention-policy.md, src/db/schema.ts, wrangler.jsonc, src/application/usecases/site/publish-article.ts","Write scope/touches: docs/spec/feat-seo-aeo-gap-closure/architecture.md, docs/spec/feat-seo-aeo-gap-closure/data-model.md, docs/spec/feat-seo-aeo-gap-closure/api-contract.md"]
...
acceptance: ["Automated commands: `pnpm run typecheck` (設計が参照する既存型契約が実在することを静的に確認する)","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-seo-aeo-gap-closure` (本 package の C12 決定論検証を世代非依存に再実行する)","Required evidence: P02 の 成果物 section に記載した produced artifacts のパス"]
architecture_refs: ["arch-system-spec-overview","arch-two-layer-platform"]
parent_feature: "feat-seo-aeo-gap-closure"
feature_package_id: "feature-package/feat-seo-aeo-gap-closure"
phase_ref: "P02"
file_path: "tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p02.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-04T02:37:00Z","origin_kind":"system-dev-planner","source_digest":"2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298","source_path":".dev-graph/published/generations/feature-package-feat-seo-aeo-gap-closure/2689733e08bc4e992eabe2e406ecea05433ae3d5312cc7e8e60876b0a3798298/task-specs/phase-02-architecture.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-seo-aeo-gap-closure の P02 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-seo-aeo-gap-closure/sys-seo-aeo-gap-closure-p02.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-f60p.2","github_mirror":null,"linked_at":"2026-09-04T04:00:00Z","sync_state":"linked"}
