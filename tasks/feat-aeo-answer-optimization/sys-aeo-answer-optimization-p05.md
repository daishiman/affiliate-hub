---
graph_node_id: "SYS-AEO-ANSWER-OPTIMIZATION-P05"
artifact_kind: "task"
artifact_subtypes: []
...
purpose: "site_aeo_profiles / article_answer_units のスキーマ、回答単位ブロックの表示、構造化データ生成、著者プロフィール面と Person 紐付け、llms.txt と AI クローラ方針の配信、および引用観測台帳の記録を実装した状態を成立させる。"
...
scope_in: ["Produced artifacts: src/db/schema.ts の site_aeo_profiles / article_answer_units 定義と drizzle マイグレーション; src/domain/aeo/ の回答単位と欠落判定; src/application/aeo/ の回答単位管理と引用観測記録; src/components/reader/answer-unit.tsx の回答単位ブロック; src/app/(reader)/llms.txt/route.ts と robots.txt の AI クローラ方針反映; src/app/admin/sites/[site]/aeo/ の方針設定画面","Consumed artifacts: features/feat-aeo-answer-optimization.md; features/feat-aeo-answer-optimization.context.json; system-spec/frontend.md; system-spec/database.md; docs/spec/feat-seo-assessment-reflection/validation-design.md","Write scope/touches: src/db/schema.ts, drizzle/, src/domain/aeo/, src/application/aeo/, src/components/reader/, src/app/(reader)/, src/app/admin/sites/[site]/aeo/"]
scope_out: ["特定の AI 検索サービスでの露出保証や順位保証 (作らない)","索引可能性・sitemap・一般的な構造化データ検査 (feat-seo-assessment-reflection が所有する)","回答単位の本文を自動生成して無承認で公開すること (行わない)","残数・優先度の提示順序 (feat-blog-scoped-admin-console が所有する)","P05 以外の phase が所有する成果物への変更"]
...
phase_ref: "P05"
file_path: "tasks/feat-aeo-answer-optimization/sys-aeo-answer-optimization-p05.md"
template_id: "task"
...
classification_reason: "feat-aeo-answer-optimization の P05 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-aeo-answer-optimization/sys-aeo-answer-optimization-p05.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-4d0q.5","github_mirror":null,"linked_at":"2026-09-04T02:09:29Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T11:01:21Z","evidence_refs":["beads:ah-4d0q.5"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
