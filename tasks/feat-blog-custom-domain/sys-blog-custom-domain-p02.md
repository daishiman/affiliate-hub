---
graph_node_id: "SYS-BLOG-CUSTOM-DOMAIN-P02"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "site_custom_domains のデータモデルと provider 連携契約の確定"
owners: ["daishiman"]
created_at: "2026-09-03T23:50:30Z"
updated_at: "2026-09-09T00:00:00Z"
status: "closed"
depends_on: ["SYS-BLOG-CUSTOM-DOMAIN-P01"]
related_nodes: []
resource_scope: ["docs/spec/feat-blog-custom-domain/data-model.md","docs/spec/feat-blog-custom-domain/admin-api-contract.md","docs/spec/feat-blog-custom-domain/host-resolution-design.md"]
purpose: "site_custom_domains のスキーマ (workspace_id / site_slug / hostname UNIQUE / status / verification_token / provider_hostname_id / cert_status / verified_at / last_checked_at / failure_reason) と、connect・verify・disconnect の3ユースケース契約、および Host ヘッダから site_slug を解決する経路の設計を確定した状態を成立させる。"
...
scope_in: ["Produced artifacts: docs/spec/feat-blog-custom-domain/data-model.md (site_custom_domains の列・制約・インデックスと既存 sites との関係); docs/spec/feat-blog-custom-domain/admin-api-contract.md (接続・検証・切断の要求/応答と失敗理由の語彙); docs/spec/feat-blog-custom-domain/host-resolution-design.md (Host ヘッダから site_slug への解決順序と既定住所への委譲条件)","Consumed artifacts: features/feat-blog-custom-domain.md; features/feat-blog-custom-domain.context.json; system-spec/infrastructure.md; system-spec/backend.md; system-spec/database.md","Write scope/touches: docs/spec/feat-blog-custom-domain/data-model.md, docs/spec/feat-blog-custom-domain/admin-api-contract.md, docs/spec/feat-blog-custom-domain/host-resolution-design.md"]
scope_out: ["ドメインの購入・レジストラ契約そのもの (利用者が外部で取得する)","自前 ACME による証明書発行 (Cloudflare for SaaS が発行する)","既定住所 (slug.基底ドメイン 形式のサブドメイン) の導出とワイルドカード経路 (feat-blog-subdomain-routing が所有する)","ドメイン状態の定期監視と期限警告の掲出順序 (feat-blog-scoped-admin-console が所有する)","P02 以外の phase が所有する成果物への変更"]
...
phase_ref: "P02"
file_path: "tasks/feat-blog-custom-domain/sys-blog-custom-domain-p02.md"
template_id: "task"
...
classification_reason: "feat-blog-custom-domain の P02 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-blog-custom-domain/sys-blog-custom-domain-p02.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-t7vv.2","github_mirror":null,"linked_at":"2026-09-04T02:05:44Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T08:11:53Z","evidence_refs":["beads:ah-t7vv.2"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
