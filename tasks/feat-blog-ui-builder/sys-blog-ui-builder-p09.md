...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-blog-ui-builder/sys-blog-ui-builder-p09.md","confidence":1.0}]
...
scope_in: ["Produced artifacts: docs/spec/feat-blog-ui-builder/quality-report.md (型検査・lint・axe-core・視覚回帰・性能の結果)","Consumed artifacts: docs/spec/feat-blog-ui-builder/migration-report.md, src/app/s/[site]/","Write scope/touches: docs/spec/feat-blog-ui-builder/quality-report.md"]
