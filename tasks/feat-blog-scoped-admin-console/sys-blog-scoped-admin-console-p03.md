---
graph_node_id: "SYS-BLOG-SCOPED-ADMIN-CONSOLE-P03"
artifact_kind: "task"
artifact_subtypes: []
...
purpose: "画面責務の排他性、既存導線からの移行漏れ、上流6 feature への依存の向きを独立観点で検査し、実装着手の可否を判定した状態を成立させる。"
goal: "画面責務の排他性、既存導線からの移行漏れ、上流6 feature への依存の向きを独立観点で検査し、実装着手の可否を判定した状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-blog-scoped-admin-console/design-review-findings.md (設計レビューの指摘と解決状況); docs/spec/feat-blog-scoped-admin-console/dependency-direction-check.md (上流6 feature への依存の向きの確認)","Consumed artifacts: features/feat-blog-scoped-admin-console.md; features/feat-blog-scoped-admin-console.context.json; system-spec/ui-ux.md; system-spec/frontend.md; docs/spec/feat-uiux-overhaul/ui-rules.md","Write scope/touches: docs/spec/feat-blog-scoped-admin-console/design-review-findings.md, docs/spec/feat-blog-scoped-admin-console/dependency-direction-check.md"]
scope_out: ["指標の集計処理そのもの (feat-blog-metrics-rollup が所有する)","読者行動の計測と記録 (feat-reader-behavior-analytics が所有する)","SEO/AEO の診断ロジックと配信 (各 feature が所有する)","ドメイン取得と証明書の発行処理 (feat-blog-custom-domain が所有する)","P03 以外の phase が所有する成果物への変更"]
...
phase_ref: "P03"
file_path: "tasks/feat-blog-scoped-admin-console/sys-blog-scoped-admin-console-p03.md"
template_id: "task"
...
classification_reason: "feat-blog-scoped-admin-console の P03 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-blog-scoped-admin-console/sys-blog-scoped-admin-console-p03.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-wois.3","github_mirror":null,"linked_at":"2026-09-04T02:10:18Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T11:18:48Z","evidence_refs":["beads:ah-wois.3"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
