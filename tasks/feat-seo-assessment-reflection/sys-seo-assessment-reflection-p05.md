---
graph_node_id: "SYS-SEO-ASSESSMENT-REFLECTION-P05"
artifact_kind: "task"
artifact_subtypes: []
...
purpose: "article_seo_assessments のスキーマ、assess-article-seo (公開・更新・月次)、構造化データの純関数検証、sitemap.xml / RSS・Atom / robots.txt の生成、apply-seo-recommendation による下書き書き戻し、および記事画面の診断表示を実装した状態を成立させる。"
...
scope_in: ["Produced artifacts: src/db/schema.ts の article_seo_assessments 定義と drizzle マイグレーション; src/domain/seo/ の指摘項目・重大度・構造化データ検証の純関数; src/domain/seo/guideline-reference.ts の出典と 90 日見直し登録; src/application/seo/assess-article-seo.ts の診断ユースケース; src/application/seo/apply-seo-recommendation.ts の下書き書き戻し; sitemap.xml / RSS・Atom / robots.txt の生成経路; src/app/admin/sites/[site]/articles/[article]/seo/ の診断画面","Consumed artifacts: features/feat-seo-assessment-reflection.md; features/feat-seo-assessment-reflection.context.json; system-spec/backend.md; system-spec/database.md; system-spec/frontend.md","Write scope/touches: src/db/schema.ts, drizzle/, src/domain/seo/, src/application/seo/, src/app/(reader)/, src/app/admin/sites/[site]/articles/[article]/seo/"]
scope_out: ["検索順位そのものの保証や、ベンダー推定の数値目標 (作らない)","公開面を直接書き換える経路 (必ず下書き経由とする)","AI 検索・回答エンジン向けの回答単位と llms.txt (feat-aeo-answer-optimization が所有する)","診断結果の残数表示と提示順序 (feat-blog-scoped-admin-console が所有する)","P05 以外の phase が所有する成果物への変更"]
...
phase_ref: "P05"
file_path: "tasks/feat-seo-assessment-reflection/sys-seo-assessment-reflection-p05.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-09-03T23:47:29Z","origin_kind":"system-dev-planner","source_digest":"7d8842a138d09aacfd5b87277165649d3c17a1ffa89019dfa4a6aa68b4480f49","source_path":".dev-graph/published/generations/feature-package-feat-seo-assessment-reflection/7d8842a138d09aacfd5b87277165649d3c17a1ffa89019dfa4a6aa68b4480f49/task-specs/phase-05-implementation.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-seo-assessment-reflection の P05 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-seo-assessment-reflection/sys-seo-assessment-reflection-p05.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-ji7d.5","github_mirror":null,"linked_at":"2026-09-04T02:08:37Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-04T10:45:34Z","evidence_refs":["beads:ah-ji7d.5"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
