---
graph_node_id: "SYS-FB-CAPTURE-EXCLUSION-P08"
artifact_kind: "task"
artifact_subtypes: []
...
related_nodes: []
resource_scope: ["src/presentation/ui/patterns","tests/e2e/app-routes.spec.ts"]
purpose: "本文の上に浮く要素の名乗りを data-floating-overlay へ統一し、写し除外と重なり監査が同一の手掛かりを共有する形へ整理した状態を成立させる。"
goal: "本文の上に浮く要素の名乗りを data-floating-overlay へ統一し、写し除外と重なり監査が同一の手掛かりを共有する形へ整理した状態を成立させる。"
scope_in: ["Produced artifacts: src/presentation/ui/patterns 配下の浮遊要素への data-floating-overlay 付与の統一; tests/e2e/app-routes.spec.ts (重なり監査の判定を共通の手掛かりへ寄せる)","Consumed artifacts: features/feat-feedback-capture-self-exclusion.md, features/feat-feedback-capture-self-exclusion.context.json, system-spec/frontend.md, docs/spec/12-改善要望フィードバック仕様.md","Write scope/touches: src/presentation/ui/patterns, tests/e2e/app-routes.spec.ts"]
...
acceptance: ["Automated commands: `pnpm run typecheck`","Automated commands: `pnpm run lint`","Automated commands: `pnpm run test:e2e`","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-feedback-capture-self-exclusion`","Required evidence: P08 の write_scope 配下の変更と E2E 実行結果"]
...
phase_ref: "P08"
file_path: "tasks/feat-feedback-capture-self-exclusion/sys-fb-capture-exclusion-p08.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-08-30T12:31:04Z","origin_kind":"system-dev-planner","source_digest":"892cd5611c443a5f90b97047a9542489c44be963ff4d775c30b640e7aca40b7d","source_path":".dev-graph/published/generations/feature-package-feat-feedback-capture-self-exclusion/892cd5611c443a5f90b97047a9542489c44be963ff4d775c30b640e7aca40b7d/task-specs/phase-08-refactoring-migration.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-feedback-capture-self-exclusion の P08 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-feedback-capture-self-exclusion/sys-fb-capture-exclusion-p08.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-0d2q.8","github_mirror":null,"linked_at":"2026-08-30T04:17:23Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-05T14:25:06Z","evidence_refs":["beads:ah-0d2q.8","dev-graph:SYS-FB-CAPTURE-EXCLUSION-P07"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
...
- Produced artifacts: src/presentation/ui/patterns 配下の浮遊要素への data-floating-overlay 付与の統一; tests/e2e/app-routes.spec.ts (重なり監査の判定を共通の手掛かりへ寄せる)
...
- Write scope/touches: src/presentation/ui/patterns, tests/e2e/app-routes.spec.ts
