---
graph_node_id: "SYS-FB-CAPTURE-EXCLUSION-P07"
artifact_kind: "task"
artifact_subtypes: []
project_id: "feature-package-feat-feedback-capture-self-exclusion"
domain: "quality"
tags: ["p07","feat-feedback-capture-self-exclusion"]
priority: null
start_date: null
target_date: null
iteration: null
...
related_nodes: []
resource_scope: ["docs/spec/feat-feedback-capture-self-exclusion/acceptance-report.md"]
purpose: "feat-feedback-capture-self-exclusion の受入7件それぞれについて、P06 のどの検査が満たしたかを一意に対応付け、未達 0 件で受入と言える状態を成立させる。"
goal: "feat-feedback-capture-self-exclusion の受入7件それぞれについて、P06 のどの検査が満たしたかを一意に対応付け、未達 0 件で受入と言える状態を成立させる。"
scope_in: ["Produced artifacts: docs/spec/feat-feedback-capture-self-exclusion/acceptance-report.md (受入7件と検査結果の一意対応・未達の有無)","Consumed artifacts: features/feat-feedback-capture-self-exclusion.md, features/feat-feedback-capture-self-exclusion.context.json, system-spec/frontend.md, docs/spec/12-改善要望フィードバック仕様.md","Write scope/touches: docs/spec/feat-feedback-capture-self-exclusion/acceptance-report.md"]
...
acceptance: ["Automated commands: `pnpm run typecheck`","Automated commands: `python3 .claude/plugins/system-dev-planner/scripts/validate-system-plan.py --repo-root . --feature-package feature-package/feat-feedback-capture-self-exclusion`","Required evidence: P07 の 成果物 section に記した produced artifacts のパスと P06 の実行ログ"]
...
phase_ref: "P07"
file_path: "tasks/feat-feedback-capture-self-exclusion/sys-fb-capture-exclusion-p07.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-08-30T12:31:04Z","origin_kind":"system-dev-planner","source_digest":"892cd5611c443a5f90b97047a9542489c44be963ff4d775c30b640e7aca40b7d","source_path":".dev-graph/published/generations/feature-package-feat-feedback-capture-self-exclusion/892cd5611c443a5f90b97047a9542489c44be963ff4d775c30b640e7aca40b7d/task-specs/phase-07-acceptance.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 1.0
classification_reason: "feat-feedback-capture-self-exclusion の P07 lifecycle 責務への確定写像"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-feedback-capture-self-exclusion/sys-fb-capture-exclusion-p07.md","confidence":1.0}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"ah-0d2q.7","github_mirror":null,"linked_at":"2026-08-30T04:17:22Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-09-05T04:01:31Z","evidence_refs":["beads:ah-0d2q.7","docs/spec/feat-feedback-capture-self-exclusion/acceptance-report.md"],"policy":"manual","reconciled_at":"2026-09-09T00:00:00Z","source":"reconciliation","status":"done"}
implementation_readiness: {"checked_at":"2026-08-30T03:45:47Z","missing_sections":[],"status":"complete"}
---

# System task overlay: 受入7件の受入判定
...
- parent_feature: feat-feedback-capture-self-exclusion
- phase_ref: P07
- classification: confidence=1.0; reason=feat-feedback-capture-self-exclusion の P07 lifecycle 責務への確定写像; candidate=tasks/feat-feedback-capture-self-exclusion/sys-fb-capture-exclusion-p07.md
...
feat-feedback-capture-self-exclusion の受入7件それぞれについて、P06 のどの検査が満たしたかを一意に対応付け、未達 0 件で受入と言える状態を成立させる。

## 背景

受入は個別の検査結果の集合ではなく、受入条件と検査の一意対応が付いて初めて判定できる。P01 の requirements-baseline.md が定めた観測手段と、P06 の実行結果を突き合わせる。
...
- Produced artifacts: docs/spec/feat-feedback-capture-self-exclusion/acceptance-report.md (受入7件と検査結果の一意対応・未達の有無)
...
- Write scope/touches: docs/spec/feat-feedback-capture-self-exclusion/acceptance-report.md
...
- PR body contract: Closes #issue (beads issue) + dev-graph graph_node_id=SYS-FB-CAPTURE-EXCLUSION-P07; PR の宛先は dev ブランチとする
- Ownership boundary: system-dev-planner は intent のみを宣言し、dev-graph が tracker mutation と reconciliation を行う

## Branch and worktree execution

- Branch: assigned after dev-graph registration by C15 as devgraph/SYS-FB-CAPTURE-EXCLUSION-P07; system-dev-planner は事前割当を行わない
- Worktree lease: claim SYS-FB-CAPTURE-EXCLUSION-P07 before implementation; heartbeat/release は dev-graph worktree lease 契約に従う
...
- Required evidence: P07 の 成果物 section に記した produced artifacts のパスと P06 の実行ログ

## Inner goal-seek execution loop

- Methodology contract: `system-task-goal-seek/v1`
- Goal: feat-feedback-capture-self-exclusion の受入7件それぞれについて、P06 のどの検査が満たしたかを一意に対応付け、未達 0 件で受入と言える状態を成立させる。
- Generic execution prompt: feat-feedback-capture-self-exclusion の goal (改善ボタンを押して撮られた写しに送信 UI が 1 画素も写らず、撮り直しでも同じ規則が効き、写しが撮れない環境でも送信 UI が待たずに開く) と本 task の 前提条件/成果物/write_scope/スコープ外 を渡し、実装手段は固定せず P07 の目的を満たす成果物を作らせる
...
- Dependencies: SYS-FB-CAPTURE-EXCLUSION-P06
