...
| `tests/application/seo/collect-seo-measurements.test.ts` | REQ-SEO10, REQ-SEO11 | 印と表 |
...
| `tests/application/seo/manage-seo-auto-apply.test.ts` | REQ-SEC01, REQ-SEO12, REQ-SEO13 | 印と表 |
| `tests/application/seo/sitemap.test.ts` | REQ-SEO02 | 印 |
| `tests/application/seo/static-audit-inventory.test.ts` | REQ-SEO06, REQ-SEO09 | 印と表 |
...
| `tests/domain/aeo-measurement.test.ts` | REQ-SEO06, REQ-SEO08, REQ-SEO09, REQ-SEO12 | 印と表 |
...
| `tests/domain/static-audit-page-key.test.ts` | REQ-SEO06, REQ-SEO09 | 印と表 |
...
| `tests/infrastructure/ai-citation-client.test.ts` | REQ-SEO08 | 印と表 |
...
| `tests/infrastructure/d1-json-array-chunks.test.ts` | REQ-SEO10 | 印 |
...
| `tests/infrastructure/search-console-client.test.ts` | REQ-SEO07 | 印と表 |
| `tests/infrastructure/secret-minter.test.ts` | REQ-FB12 | 印と表 |
| `tests/infrastructure/security-headers.test.ts` | REQ-SEC11 | 印と表 |
| `tests/infrastructure/seo-measurement-scheduler.test.ts` | REQ-SEO10 | 印と表 |
...
| `tests/integration/d1-migration-0050.test.ts` | REQ-SEO08 | 印 |
...
| `tests/integration/d1-seo-approved-revisions.test.ts` | REQ-SEO08, REQ-SEO12 | 印 |
| `tests/integration/d1-seo-backlog.test.ts` | REQ-SEO13 | 印 |
| `tests/integration/d1-seo-citation-budget.test.ts` | REQ-SEO10 | 印と表 |
| `tests/integration/d1-seo-page-metrics.test.ts` | REQ-SEO10, REQ-SEO11 | 印 |
| `tests/integration/d1-seo-search-query-metrics.test.ts` | REQ-SEO10, REQ-SEO11 | 印 |
| `tests/integration/d1-seo-static-audit.test.ts` | REQ-SEO10 | 印と表 |
...
| `tests/integration/workerd-static-audit-collector.test.ts` | REQ-SEO06 | 印と表 |
...
| `tests/ui/blog-articles-seo-link.test.tsx` | REQ-SEO13 | 印 |
...
| `tests/ui/seo-aeo-action.test.ts` | REQ-SEO13 | 印と表 |
| `tests/ui/seo-dashboard.test.tsx` | REQ-SEO13 | 印と表 |
| `tests/ui/seo-revision-preview.test.tsx` | REQ-SEO13 | 印 |
...
<!-- 生成物の指紋 sha256:5c1137606c6f942a41624f29ae6dfe443c4f5d4be6f444308c0ee0de76d08ef1 -->
