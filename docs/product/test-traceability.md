...
- `tests/presentation/nav-grouping.test.ts`
...
- `tests/ui/layout-density.test.ts`
...
| `tests/integration/d1-improvement.test.ts` | REQ-IM13 | 印 |
...
| `tests/ui/axe-rule-coverage.test.ts` | REQ-TS06 | 印と表 |
...
| `tests/ui/icon-name.test.ts` | REQ-B02, REQ-B08 | 印 |
...
<!-- 生成物の指紋 sha256:238b87bd270b328b4bffc80278224744d8382477a53546354315647761f11ebd -->
