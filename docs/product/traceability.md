...
- 最終更新: 2026-08-17 / 対象: 作業中の `feat/clean-architecture-skeleton`（成果の金額を直す入口と保存先をつなぎ、取込額を残したまま手修正を保存できるところまで）
