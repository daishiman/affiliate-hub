...
| REQ-P02 | has-input, has-external, has-screen | `a11y` `boundary` `equivalence` `fault-injection` `idempotency` `keyboard` `screen-states` | `a11y` `equivalence` `idempotency` `keyboard` `screen-states` | `boundary` `fault-injection` | 
...
| REQ-SEC02 | has-input | `boundary` `equivalence` | `boundary` `equivalence` | — | 
...
| REQ-SEC06 | has-input | `boundary` `equivalence` | `equivalence` | `boundary` | 
| REQ-SEC07 | has-input | `boundary` `equivalence` | `equivalence` | `boundary` | 
| REQ-SEC08 | has-screen | `a11y` `keyboard` `screen-states` | `a11y` `keyboard` `screen-states` | — | 
| REQ-SEC09 | has-input | `boundary` `equivalence` | `equivalence` | `boundary` | 
