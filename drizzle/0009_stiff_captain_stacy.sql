CREATE TABLE `content_variants` (
	...
	`audience_persona_id` text NOT NULL,
	`angle` text NOT NULL,
	`title` text,
	`body` text NOT NULL,
	...
	`platform_warnings` text NOT NULL,
...
CREATE INDEX `content_variants_workspace_state_idx` ON `content_variants` (`workspace_id`,`state`);--> statement-breakpoint
CREATE INDEX `content_variants_workspace_package_idx` ON `content_variants` (`workspace_id`,`content_package_id`);--> statement-breakpoint
