CREATE TABLE `memberships` (
	...
	`roles` text NOT NULL,
	`scoped_brand_ids` text NOT NULL,
...
CREATE UNIQUE INDEX `memberships_workspace_email_idx` ON `memberships` (`workspace_id`,`invited_email`);--> statement-breakpoint
CREATE INDEX `memberships_user_idx` ON `memberships` (`user_id`);--> statement-breakpoint
CREATE TABLE `signin_denials` (
	`id` text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `signin_denials_email_idx` ON `signin_denials` (`email`,`at`);--> statement-breakpoint
