...
- `seed knowledge` は現在の Clean Architecture / Design Patterns / API Design Patterns / Secure by Design / DDD / Clean Code / Usability & Accessibility / Information Design / Test Strategy / Continuous Delivery / Site Reliability Engineering / taxonomy であり、知識領域の固定上限ではない。
