...
updated_at: "2026-09-04T06:00:31.979358Z"
status: "active"
...
scope_out: ["記事本文の AI 生成そのもの (feat-ai-content-studio)","アフィリエイト URL の登録・商品識別 (feat-affiliate-inbox / feat-affiliate-hub)","クリック計測・成果突合の分析基盤 (feat-analytics-insight)","管理画面全体の単一用途画面再編 (feat-uiux-overhaul)","独自ドメイン・DNS 運用、テーマの外部販売","SEO/AEO の未実装差分 (HowTo・Speakable の JSON-LD、公開時点検の履歴保持、公開後の定期再解析) は feat-seo-aeo-gap-closure が持つ。本 feature の scope_in には HowTo が列挙されているが、実装は src/application/seo/structured-data.ts に無く、そこだけ切り出した"]
...
source_lineage: {"imported_at":"2026-09-03T00:00:00Z","origin_kind":"generated","source_digest":"33d644c2cb19eee116a4d365c0a50c84c697f9a2e9afcc7afef6f06a3d9ad527","source_path":"system-spec/ui-ux.md","source_plugin":"dev-graph","source_version":"0.1.0"}
