...
- Produced artifacts: dev ブランチへの PR (本 feature の全変更); docs/spec/feat-feedback-capture-self-exclusion/release-notes.md (変更点・影響範囲・切り戻し手順)
...
- Write scope/touches: docs/spec/feat-feedback-capture-self-exclusion/release-notes.md
...
- P13 spec/architecture writeback: 本 feature の確定内容を docs/spec と dev-graph へ書き戻す
