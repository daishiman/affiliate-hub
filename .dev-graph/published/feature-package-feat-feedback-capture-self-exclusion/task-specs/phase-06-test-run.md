...
- Produced artifacts: tests 配下の単体テスト (撮影と可視化の順序・退避経路・復元の振る舞い); tests/e2e 配下の E2E テスト (改善ボタンからの写しに送信 UI が含まれないこと・撮り直し・属性付与漏れの検出)
...
- Write scope/touches: tests, tests/e2e
