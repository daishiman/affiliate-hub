...
const FACTS: readonly SampleFact[] = [
  {
    siteId: "site_home_office",
    articleId: "art_chairs_ranking",
    productId: "p_alpha_15",
    authorId: "author_ai",
    personaId: "persona_remote_worker",
    channel: "own_site",
    angle: "予算から選ぶ",
    cta: "価格を見る",
    merchant: "家電量販A",
  ...
  {
    siteId: "site_home_office",
    articleId: "art_desk_lighting",
    productId: "p_beta_14",
    authorId: "author_ai",
    personaId: "persona_runner",
    channel: "own_site",
    angle: "作業時間から選ぶ",
    cta: "価格を見る",
    merchant: "通販B",
  ...
  },
  {
    ...
    siteId: "site_run_recover",
    articleId: "art_shoes_ranking",
    productId: "p_beta_14",
    authorId: "author_human",
    personaId: "persona_runner",
    channel: "youtube",
