...
export const ADMIN_SCREEN_RUNTIME_ENTRIES: readonly AdminScreenRuntimeEntry[] = [
  ...
  */
  ...
  screenMutation(
    ...
    edge("src/presentation/admin/blog-appearance-form.tsx", "BlogAppearanceForm"),
    edge("src/presentation/admin/blog-appearance-action.ts", "manageBlogAppearanceAction"),
  ),
  /*
  ...
  */
  screenMutation(
    ...
    "sites/[site]/appearance",
    edge("src/presentation/admin/blog-appearance-form.tsx", "PageThemeOverrideForms"),
    edge("src/presentation/admin/blog-appearance-action.ts", "manageBlogAppearanceAction"),
  ),
  screenMutation(
    "site.save-placement",
    "sites/[site]/placements",
    edge("src/presentation/admin/blog-placement-form.tsx", "BlogPlacementForm"),
    edge("src/presentation/admin/blog-placement-action.ts", "manageBlogPlacementAction"),
  ),
  screenMutation(
    "site.delete",
    "sites/[site]",
  ...
  */
  ...
  screenMutation(
    ...
    "blog/articles/[article]",
    edge("src/presentation/admin/expression-block-form.tsx", "ExpressionBlockAppendForm"),
    edge("src/presentation/admin/blog-article-action.ts", "manageBlogArticleAction"),
  ),
  screenMutation(
