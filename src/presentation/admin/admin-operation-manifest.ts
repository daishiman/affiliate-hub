...
export const ADMIN_OPERATION_MANIFEST = [
  ...
  },
  {
    ...
    label: "作成",
    uiEntry: {
      module: "src/presentation/admin/site-wizard-form.tsx",
      exportName: "SiteWizardStepForm",
    },
    uiRoute: "/admin/sites/new",
    formAction: {
      kind: "server-action",
      module: "src/presentation/admin/site-wizard-action.ts",
  ...
  },
  {
    ...
    operation: "update",
    label: "更新",
    uiEntry: { module: "src/presentation/admin/site-form.tsx", exportName: "UpdateSiteForm" },
    uiRoute: "/admin/sites/[site]/edit",
    formAction: {
      kind: "server-action",
      module: "src/presentation/admin/site-form-action.ts",
  ...
  },
  {
    ...
    operation: "create",
    label: "作成",
    uiEntry: { module: "src/presentation/admin/content-form.tsx", exportName: "CreateContentForm" },
    uiRoute: "/admin/content/new",
    formAction: {
      kind: "server-action",
      module: "src/presentation/admin/content-form-action.ts",
  ...
  },
  {
    ...
    operation: "update",
    label: "更新",
    uiEntry: { module: "src/presentation/admin/content-form.tsx", exportName: "UpdateContentForm" },
  ...
  },
  {
    ...
    operation: "create",
    label: "作成",
    uiEntry: { module: "src/presentation/admin/product-form.tsx", exportName: "CreateProductForm" },
    uiRoute: "/admin/products/new",
    formAction: {
      kind: "server-action",
      module: "src/presentation/admin/product-form-action.ts",
  ...
  },
  {
    ...
    operation: "update",
    label: "更新",
    uiEntry: { module: "src/presentation/admin/product-form.tsx", exportName: "UpdateProductForm" },
  ...
  },
  {
    ...
    label: "更新",
    uiEntry: {
      module: "src/presentation/admin/publication-form.tsx",
      exportName: "UpdatePublicationForm",
    },
    uiRoute: "/admin/distribution/[publication]/edit",
    formAction: {
      kind: "server-action",
      module: "src/presentation/admin/publication-form-action.ts",
