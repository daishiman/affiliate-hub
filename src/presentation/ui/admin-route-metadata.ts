...
const ADMIN_ROUTE_DEFINITIONS = {
  "": { label: "ホーム", parent: null, nav: { group: null, requires: null, icon: "🏠" } },
  products: nav("商品", "material", "product.read", "📦"),
  ...
  evidence: nav("根拠", "material", "content.read", "🔍"),
  rankings: nav("評価基準と順位", "material", "content.read", "🏆"),
  "rankings/criteria": child("rankings", "評価基準"),
  content: nav("記事", "write", "content.read", "📝"),
  ...
  affiliate: nav("提携と成果", "earn", "affiliate.read_revenue", "🤝"),
  "affiliate/[conversion]": child("affiliate", null),
  inbox: nav("成果リンクの受信箱", "earn", "affiliate.read_revenue", "📥"),
  analytics: nav("数字", "observe", "analytics.read", "📊"),
  "ai-usage": nav("AI の利用と費用", "observe", "analytics.read", "💰"),
  improvement: nav("改善の状況", "observe", "analytics.read", "📈"),
  "improvement/dimensions": child("improvement", "改善の観点"),
  feedback: nav("使い勝手を直す", "maintain", "feedback.read", "💬"),
  "feedback/[report]": child("feedback", null),
  tools: nav("AI から使える道具", "maintain", "content.read", "🛠️"),
  "ui-catalog": nav("画面部品の見本", "maintain", "content.read", "🧩"),
  settings: nav("設定", "maintain", "content.read", "🔧"),
