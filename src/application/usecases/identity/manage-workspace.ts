...
export const AUDIT_ACTION_LABEL: Readonly<Record<AuditAction, string>> = {
  ...
  "blog_appearance.changed": "ブログの見せ方・配色を変えた",
  "blog_placement.changed": "記事への成果リンクの掲載を記録した",
  "blog_placement.removed": "記事から成果リンクの掲載を外した",
  "blog_delivery.changed": "配信部品の入切を変えた",
  "blog_delivery.checked": "配信物を点検した",
  "indexnow.notification_finished": "IndexNow への公開 URL 通知が終わった",
