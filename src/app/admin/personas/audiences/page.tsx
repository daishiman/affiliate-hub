 ...
 */
export default async function LegacyAudiencePersonasPage({
  searchParams,
}: {
  readonly searchParams: Promise<Record<string, string | readonly string[] | undefined>>;
}) {
  redirect(await legacyAdminRedirect("/admin/personas/audiences", await searchParams));
}
